...
!MESSAGE
!MESSAGE NMAKE /f "Makefile.RTCORBA_Callback_Client.mak" CFG="Win64 Debug"
!MESSAGE
...
OUTDIR=.
INSTALLDIR=.
INTDIR=Debug\RTCORBA_Callback_Client\IA64
...
!ELSE
	$(DEPGEN) -I"..\..\..\..\.." -I"..\..\..\.." -I"..\..\..\..\orbsvcs" -I"..\lib" -D_DEBUG -DWIN64 -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -f "Makefile.RTCORBA_Callback_Client.dep" "client.cpp" "Callback.cpp" "TestS.cpp" "TestC.cpp"
!ENDIF
...
"$(INTDIR)" :
	...
	if not exist "Debug\RTCORBA_Callback_Client\$(NULL)" mkdir "Debug\RTCORBA_Callback_Client"
...
OUTDIR=Release
INSTALLDIR=Release
INTDIR=Release\RTCORBA_Callback_Client\IA64
...
!IF "$(DEPGEN)" == ""
	...
	@echo http://www.ociweb.com/products/mpc/down.html
!ELSE
	$(DEPGEN) -I"..\..\..\..\.." -I"..\..\..\.." -I"..\..\..\..\orbsvcs" -I"..\lib" -DNDEBUG -DWIN64 -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -f "Makefile.RTCORBA_Callback_Client.dep" "client.cpp" "Callback.cpp" "TestS.cpp" "TestC.cpp"
!ENDIF
...
"$(INTDIR)" :
	...
	if not exist "Release\RTCORBA_Callback_Client\$(NULL)" mkdir "Release\RTCORBA_Callback_Client"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
INTDIR=Static_Debug\RTCORBA_Callback_Client\IA64
...
!IF "$(DEPGEN)" == ""
	...
	@echo http://www.ociweb.com/products/mpc/down.html
!ELSE
	$(DEPGEN) -I"..\..\..\..\.." -I"..\..\..\.." -I"..\..\..\..\orbsvcs" -I"..\lib" -D_DEBUG -DWIN64 -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -DACE_AS_STATIC_LIBS -DTAO_AS_STATIC_LIBS -f "Makefile.RTCORBA_Callback_Client.dep" "client.cpp" "Callback.cpp" "TestS.cpp" "TestC.cpp"
!ENDIF
...
"$(INTDIR)" :
	...
	if not exist "Static_Debug\RTCORBA_Callback_Client\$(NULL)" mkdir "Static_Debug\RTCORBA_Callback_Client"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
INTDIR=Static_Release\RTCORBA_Callback_Client\IA64
...
!IF "$(DEPGEN)" == ""
	...
	@echo http://www.ociweb.com/products/mpc/down.html
!ELSE
	$(DEPGEN) -I"..\..\..\..\.." -I"..\..\..\.." -I"..\..\..\..\orbsvcs" -I"..\lib" -DNDEBUG -DWIN64 -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -DACE_AS_STATIC_LIBS -DTAO_AS_STATIC_LIBS -f "Makefile.RTCORBA_Callback_Client.dep" "client.cpp" "Callback.cpp" "TestS.cpp" "TestC.cpp"
!ENDIF
...
"$(INTDIR)" :
	...
	if not exist "Static_Release\RTCORBA_Callback_Client\$(NULL)" mkdir "Static_Release\RTCORBA_Callback_Client"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
!IF EXISTS("Makefile.RTCORBA_Callback_Client.dep")
!INCLUDE "Makefile.RTCORBA_Callback_Client.dep"
!ENDIF
!ENDIF
...
"$(INTDIR)\Callback.obj" : $(SOURCE)
	$(CPP) $(CPP_COMMON) /Fo"$(INTDIR)\Callback.obj" $(SOURCE)
...
!IF "$(NO_EXTERNAL_DEPS)" != "1"
!IF EXISTS("Makefile.RTCORBA_Callback_Client.dep")
	@echo Using "Makefile.RTCORBA_Callback_Client.dep"
!ELSE
	@echo Warning: cannot find "Makefile.RTCORBA_Callback_Client.dep"
!ENDIF
!ENDIF
