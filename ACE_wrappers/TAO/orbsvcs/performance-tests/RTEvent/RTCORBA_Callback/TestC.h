...
#ifndef _TAO_IDL_TESTC_V9B29C_H_
#define _TAO_IDL_TESTC_V9B29C_H_
...
#define _TEST_SESSION_FACTORY__VAR_OUT_CH_
  ...
  private:
    TAO::Collocation_Proxy_Broker *the_TAO_Session_Factory_Proxy_Broker_;
  ...
  protected:
    ...
    virtual void Test_Session_Factory_setup_collocation (void);
  ...
  private:
    TAO::Collocation_Proxy_Broker *the_TAO_Session_Proxy_Broker_;
  ...
  protected:
    ...
    // These methods traverse the inheritance tree and set the
    // parents piece of the given class in the right mode.
    virtual void Test_Session_setup_collocation (void);
  ...
  private:
    TAO::Collocation_Proxy_Broker *the_TAO_Callback_Proxy_Broker_;
  ...
  protected:
    ...
    // These methods traverse the inheritance tree and set the
    // parents piece of the given class in the right mode.
    virtual void Test_Callback_setup_collocation (void);
