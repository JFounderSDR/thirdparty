...
!MESSAGE
!MESSAGE NMAKE /f "Makefile.RTCORBA_Callback_IDL.mak" CFG="Win64 Debug"
!MESSAGE
...
OUTDIR=.
INTDIR=Debug\RTCORBA_Callback_IDL\IA64
...
"$(INTDIR)" :
	...
	if not exist "Debug\RTCORBA_Callback_IDL\$(NULL)" mkdir "Debug\RTCORBA_Callback_IDL"
...
OUTDIR=.
INTDIR=Release\RTCORBA_Callback_IDL\IA64
...
"$(INTDIR)" :
	...
	if not exist "Release\RTCORBA_Callback_IDL\$(NULL)" mkdir "Release\RTCORBA_Callback_IDL"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
OUTDIR=.
INTDIR=Static_Debug\RTCORBA_Callback_IDL\IA64
...
"$(INTDIR)" :
	...
	if not exist "Static_Debug\RTCORBA_Callback_IDL\$(NULL)" mkdir "Static_Debug\RTCORBA_Callback_IDL"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
OUTDIR=.
INTDIR=Static_Release\RTCORBA_Callback_IDL\IA64
...
"$(INTDIR)" :
	...
	if not exist "Static_Release\RTCORBA_Callback_IDL\$(NULL)" mkdir "Static_Release\RTCORBA_Callback_IDL"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
!IF EXISTS("Makefile.RTCORBA_Callback_IDL.dep")
!INCLUDE "Makefile.RTCORBA_Callback_IDL.dep"
!ENDIF
!ENDIF
...
!IF "$(NO_EXTERNAL_DEPS)" != "1"
!IF EXISTS("Makefile.RTCORBA_Callback_IDL.dep")
	@echo Using "Makefile.RTCORBA_Callback_IDL.dep"
!ENDIF
!ENDIF
