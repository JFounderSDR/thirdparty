...
!MESSAGE
!MESSAGE NMAKE /f "Makefile.Federated_Roundtrip_Server.mak" CFG="Win64 Debug"
!MESSAGE
...
OUTDIR=.
INSTALLDIR=.
INTDIR=Debug\Federated_Roundtrip_Server\IA64
...
!ELSE
	$(DEPGEN) -I"..\..\..\..\.." -I"..\..\..\.." -I"..\..\..\..\orbsvcs" -I"..\lib" -D_DEBUG -DWIN64 -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -f "Makefile.Federated_Roundtrip_Server.dep" "server.cpp"
!ENDIF
...
"$(INTDIR)" :
	...
	if not exist "Debug\Federated_Roundtrip_Server\$(NULL)" mkdir "Debug\Federated_Roundtrip_Server"
...
OUTDIR=Release
INSTALLDIR=Release
INTDIR=Release\Federated_Roundtrip_Server\IA64
...
!IF "$(DEPGEN)" == ""
	...
	@echo http://www.ociweb.com/products/mpc/down.html
!ELSE
	$(DEPGEN) -I"..\..\..\..\.." -I"..\..\..\.." -I"..\..\..\..\orbsvcs" -I"..\lib" -DNDEBUG -DWIN64 -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -f "Makefile.Federated_Roundtrip_Server.dep" "server.cpp"
!ENDIF
...
"$(INTDIR)" :
	...
	if not exist "Release\Federated_Roundtrip_Server\$(NULL)" mkdir "Release\Federated_Roundtrip_Server"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
INTDIR=Static_Debug\Federated_Roundtrip_Server\IA64
...
!IF "$(DEPGEN)" == ""
	...
	@echo http://www.ociweb.com/products/mpc/down.html
!ELSE
	$(DEPGEN) -I"..\..\..\..\.." -I"..\..\..\.." -I"..\..\..\..\orbsvcs" -I"..\lib" -D_DEBUG -DWIN64 -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -DACE_AS_STATIC_LIBS -DTAO_AS_STATIC_LIBS -f "Makefile.Federated_Roundtrip_Server.dep" "server.cpp"
!ENDIF
...
"$(INTDIR)" :
	...
	if not exist "Static_Debug\Federated_Roundtrip_Server\$(NULL)" mkdir "Static_Debug\Federated_Roundtrip_Server"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
INTDIR=Static_Release\Federated_Roundtrip_Server\IA64
...
!IF "$(DEPGEN)" == ""
	...
	@echo http://www.ociweb.com/products/mpc/down.html
!ELSE
	$(DEPGEN) -I"..\..\..\..\.." -I"..\..\..\.." -I"..\..\..\..\orbsvcs" -I"..\lib" -DNDEBUG -DWIN64 -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -DACE_AS_STATIC_LIBS -DTAO_AS_STATIC_LIBS -f "Makefile.Federated_Roundtrip_Server.dep" "server.cpp"
!ENDIF
...
"$(INTDIR)" :
	...
	if not exist "Static_Release\Federated_Roundtrip_Server\$(NULL)" mkdir "Static_Release\Federated_Roundtrip_Server"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
!IF EXISTS("Makefile.Federated_Roundtrip_Server.dep")
!INCLUDE "Makefile.Federated_Roundtrip_Server.dep"
!ENDIF
!ENDIF
...
!IF "$(NO_EXTERNAL_DEPS)" != "1"
!IF EXISTS("Makefile.Federated_Roundtrip_Server.dep")
	@echo Using "Makefile.Federated_Roundtrip_Server.dep"
!ELSE
	@echo Warning: cannot find "Makefile.Federated_Roundtrip_Server.dep"
!ENDIF
!ENDIF
