...
!MESSAGE
!MESSAGE NMAKE /f "Makefile.Colocated_Roundtrip.mak" CFG="Win64 Debug"
!MESSAGE
...
OUTDIR=.
INSTALLDIR=.
INTDIR=Debug\Colocated_Roundtrip\IA64

ALL : "$(INTDIR)" "$(OUTDIR)" DEPENDCHECK $(GENERATED_DIRTY) "$(INSTALLDIR)\driver.exe"
...
!ELSE
	$(DEPGEN) -I"..\..\..\..\.." -I"..\..\..\.." -I"..\..\..\..\orbsvcs" -I"..\lib" -D_DEBUG -DWIN64 -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -f "Makefile.Colocated_Roundtrip.dep" "driver.cpp"
!ENDIF

REALCLEAN : CLEAN
	-@del /f/q "$(INSTALLDIR)\driver.pdb"
	-@del /f/q "$(INSTALLDIR)\driver.exe"
	-@del /f/q "$(INSTALLDIR)\driver.ilk"

"$(INTDIR)" :
	if not exist "Debug\$(NULL)" mkdir "Debug"
	if not exist "Debug\Colocated_Roundtrip\$(NULL)" mkdir "Debug\Colocated_Roundtrip"
...
!IF "$(DEPGEN)" == ""
	...
	@echo http://www.ociweb.com/products/mpc/down.html
!ELSE
	$(DEPGEN) -I"..\..\..\..\.." -I"..\..\..\.." -I"..\..\..\..\orbsvcs" -I"..\lib" -DNDEBUG -DWIN64 -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -f "Makefile.Colocated_Roundtrip.dep" "driver.cpp"
!ENDIF
...
"$(INTDIR)" :
	...
	if not exist "Release\Colocated_Roundtrip\$(NULL)" mkdir "Release\Colocated_Roundtrip"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
INTDIR=Static_Debug\Colocated_Roundtrip\IA64
...
!IF "$(DEPGEN)" == ""
	...
	@echo http://www.ociweb.com/products/mpc/down.html
!ELSE
	$(DEPGEN) -I"..\..\..\..\.." -I"..\..\..\.." -I"..\..\..\..\orbsvcs" -I"..\lib" -D_DEBUG -DWIN64 -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -DACE_AS_STATIC_LIBS -DTAO_AS_STATIC_LIBS -f "Makefile.Colocated_Roundtrip.dep" "driver.cpp"
!ENDIF
...
"$(INTDIR)" :
	...
	if not exist "Static_Debug\Colocated_Roundtrip\$(NULL)" mkdir "Static_Debug\Colocated_Roundtrip"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
INTDIR=Static_Release\Colocated_Roundtrip\IA64
...
!IF "$(DEPGEN)" == ""
	...
	@echo http://www.ociweb.com/products/mpc/down.html
!ELSE
	$(DEPGEN) -I"..\..\..\..\.." -I"..\..\..\.." -I"..\..\..\..\orbsvcs" -I"..\lib" -DNDEBUG -DWIN64 -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -DACE_AS_STATIC_LIBS -DTAO_AS_STATIC_LIBS -f "Makefile.Colocated_Roundtrip.dep" "driver.cpp"
!ENDIF
...
"$(INTDIR)" :
	...
	if not exist "Static_Release\Colocated_Roundtrip\$(NULL)" mkdir "Static_Release\Colocated_Roundtrip"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
!IF EXISTS("Makefile.Colocated_Roundtrip.dep")
!INCLUDE "Makefile.Colocated_Roundtrip.dep"
!ENDIF
!ENDIF
...
!IF "$(NO_EXTERNAL_DEPS)" != "1"
!IF EXISTS("Makefile.Colocated_Roundtrip.dep")
	@echo Using "Makefile.Colocated_Roundtrip.dep"
!ELSE
	@echo Warning: cannot find "Makefile.Colocated_Roundtrip.dep"
!ENDIF
!ENDIF
