...
!MESSAGE
!MESSAGE NMAKE /f "Makefile.Roundtrip_RTEvent_Client.mak" CFG="Win64 Debug"
!MESSAGE
...
OUTDIR=.
INSTALLDIR=.
INTDIR=Debug\Roundtrip_RTEvent_Client\IA64
...
!ELSE
	$(DEPGEN) -I"..\..\..\..\.." -I"..\..\..\.." -I"..\..\..\..\orbsvcs" -I"..\lib" -D_DEBUG -DWIN64 -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -f "Makefile.Roundtrip_RTEvent_Client.dep" "client.cpp"
!ENDIF
...
"$(INTDIR)" :
	...
	if not exist "Debug\Roundtrip_RTEvent_Client\$(NULL)" mkdir "Debug\Roundtrip_RTEvent_Client"
...
OUTDIR=Release
INSTALLDIR=Release
INTDIR=Release\Roundtrip_RTEvent_Client\IA64
...
!IF "$(DEPGEN)" == ""
	...
	@echo http://www.ociweb.com/products/mpc/down.html
!ELSE
	$(DEPGEN) -I"..\..\..\..\.." -I"..\..\..\.." -I"..\..\..\..\orbsvcs" -I"..\lib" -DNDEBUG -DWIN64 -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -f "Makefile.Roundtrip_RTEvent_Client.dep" "client.cpp"
!ENDIF
...
"$(INTDIR)" :
	...
	if not exist "Release\Roundtrip_RTEvent_Client\$(NULL)" mkdir "Release\Roundtrip_RTEvent_Client"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
INTDIR=Static_Debug\Roundtrip_RTEvent_Client\IA64
...
!IF "$(DEPGEN)" == ""
	...
	@echo http://www.ociweb.com/products/mpc/down.html
!ELSE
	$(DEPGEN) -I"..\..\..\..\.." -I"..\..\..\.." -I"..\..\..\..\orbsvcs" -I"..\lib" -D_DEBUG -DWIN64 -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -DACE_AS_STATIC_LIBS -DTAO_AS_STATIC_LIBS -f "Makefile.Roundtrip_RTEvent_Client.dep" "client.cpp"
!ENDIF
...
"$(INTDIR)" :
	...
	if not exist "Static_Debug\Roundtrip_RTEvent_Client\$(NULL)" mkdir "Static_Debug\Roundtrip_RTEvent_Client"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
INTDIR=Static_Release\Roundtrip_RTEvent_Client\IA64
...
!IF "$(DEPGEN)" == ""
	...
	@echo http://www.ociweb.com/products/mpc/down.html
!ELSE
	$(DEPGEN) -I"..\..\..\..\.." -I"..\..\..\.." -I"..\..\..\..\orbsvcs" -I"..\lib" -DNDEBUG -DWIN64 -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -DACE_AS_STATIC_LIBS -DTAO_AS_STATIC_LIBS -f "Makefile.Roundtrip_RTEvent_Client.dep" "client.cpp"
!ENDIF
...
"$(INTDIR)" :
	...
	if not exist "Static_Release\Roundtrip_RTEvent_Client\$(NULL)" mkdir "Static_Release\Roundtrip_RTEvent_Client"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
!IF EXISTS("Makefile.Roundtrip_RTEvent_Client.dep")
!INCLUDE "Makefile.Roundtrip_RTEvent_Client.dep"
!ENDIF
!ENDIF
...
!IF "$(NO_EXTERNAL_DEPS)" != "1"
!IF EXISTS("Makefile.Roundtrip_RTEvent_Client.dep")
	@echo Using "Makefile.Roundtrip_RTEvent_Client.dep"
!ELSE
	@echo Warning: cannot find "Makefile.Roundtrip_RTEvent_Client.dep"
!ENDIF
!ENDIF
