...
!MESSAGE
!MESSAGE NMAKE /f "Makefile.TCP_Baseline_Client.mak" CFG="Win64 Debug"
!MESSAGE
...
OUTDIR=.
INSTALLDIR=.
INTDIR=Debug\TCP_Baseline_Client\IA64
...
!ELSE
	$(DEPGEN) -I"..\..\..\..\.." -I"..\..\..\.." -I"..\..\..\..\orbsvcs" -I"..\lib" -D_DEBUG -DWIN64 -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -f "Makefile.TCP_Baseline_Client.dep" "client.cpp"
!ENDIF
...
"$(INTDIR)" :
	...
	if not exist "Debug\TCP_Baseline_Client\$(NULL)" mkdir "Debug\TCP_Baseline_Client"
...
OUTDIR=Release
INSTALLDIR=Release
INTDIR=Release\TCP_Baseline_Client\IA64
...
!IF "$(DEPGEN)" == ""
	...
	@echo http://www.ociweb.com/products/mpc/down.html
!ELSE
	$(DEPGEN) -I"..\..\..\..\.." -I"..\..\..\.." -I"..\..\..\..\orbsvcs" -I"..\lib" -DNDEBUG -DWIN64 -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -f "Makefile.TCP_Baseline_Client.dep" "client.cpp"
!ENDIF
...
"$(INTDIR)" :
	...
	if not exist "Release\TCP_Baseline_Client\$(NULL)" mkdir "Release\TCP_Baseline_Client"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
INTDIR=Static_Debug\TCP_Baseline_Client\IA64
...
!IF "$(DEPGEN)" == ""
	...
	@echo http://www.ociweb.com/products/mpc/down.html
!ELSE
	$(DEPGEN) -I"..\..\..\..\.." -I"..\..\..\.." -I"..\..\..\..\orbsvcs" -I"..\lib" -D_DEBUG -DWIN64 -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -DACE_AS_STATIC_LIBS -DTAO_AS_STATIC_LIBS -f "Makefile.TCP_Baseline_Client.dep" "client.cpp"
!ENDIF
...
"$(INTDIR)" :
	...
	if not exist "Static_Debug\TCP_Baseline_Client\$(NULL)" mkdir "Static_Debug\TCP_Baseline_Client"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
INTDIR=Static_Release\TCP_Baseline_Client\IA64
...
!IF "$(DEPGEN)" == ""
	...
	@echo http://www.ociweb.com/products/mpc/down.html
!ELSE
	$(DEPGEN) -I"..\..\..\..\.." -I"..\..\..\.." -I"..\..\..\..\orbsvcs" -I"..\lib" -DNDEBUG -DWIN64 -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -DACE_AS_STATIC_LIBS -DTAO_AS_STATIC_LIBS -f "Makefile.TCP_Baseline_Client.dep" "client.cpp"
!ENDIF
...
"$(INTDIR)" :
	...
	if not exist "Static_Release\TCP_Baseline_Client\$(NULL)" mkdir "Static_Release\TCP_Baseline_Client"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
!IF EXISTS("Makefile.TCP_Baseline_Client.dep")
!INCLUDE "Makefile.TCP_Baseline_Client.dep"
!ENDIF
!ENDIF
...
!IF "$(NO_EXTERNAL_DEPS)" != "1"
!IF EXISTS("Makefile.TCP_Baseline_Client.dep")
	@echo Using "Makefile.TCP_Baseline_Client.dep"
!ELSE
	@echo Warning: cannot find "Makefile.TCP_Baseline_Client.dep"
!ENDIF
!ENDIF
