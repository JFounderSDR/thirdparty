  ...
  ::CORBA::Long workload_in_usecs)
{
  ...
  if (this->the_TAO_Roundtrip_Proxy_Broker_ == 0)
    {
      Test_Roundtrip_setup_collocation ();
    }
  ...
  TAO::Invocation_Adapter _tao_call (
      ...
      "test_method",
      11,
      this->the_TAO_Roundtrip_Proxy_Broker_
    );
...
Test::Roundtrip::Roundtrip (void)
 : the_TAO_Roundtrip_Proxy_Broker_ (0)
{
  this->Test_Roundtrip_setup_collocation ();
}

void
Test::Roundtrip::Test_Roundtrip_setup_collocation ()
{
  if (::Test__TAO_Roundtrip_Proxy_Broker_Factory_function_pointer)
    {
      this->the_TAO_Roundtrip_Proxy_Broker_ =
        ::Test__TAO_Roundtrip_Proxy_Broker_Factory_function_pointer (this);
    }
}
