...
!MESSAGE
!MESSAGE NMAKE /f "Makefile.RTCORBA_Baseline_Client.mak" CFG="Win64 Debug"
!MESSAGE
...
OUTDIR=.
INSTALLDIR=.
INTDIR=Debug\RTCORBA_Baseline_Client\IA64
...
!ELSE
	$(DEPGEN) -I"..\..\..\..\.." -I"..\..\..\.." -I"..\..\..\..\orbsvcs" -I"..\lib" -D_DEBUG -DWIN64 -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -f "Makefile.RTCORBA_Baseline_Client.dep" "TestC.cpp" "client.cpp"
!ENDIF
...
"$(INTDIR)" :
	...
	if not exist "Debug\RTCORBA_Baseline_Client\$(NULL)" mkdir "Debug\RTCORBA_Baseline_Client"
...
OUTDIR=Release
INSTALLDIR=Release
INTDIR=Release\RTCORBA_Baseline_Client\IA64
...
!IF "$(DEPGEN)" == ""
	...
	@echo http://www.ociweb.com/products/mpc/down.html
!ELSE
	$(DEPGEN) -I"..\..\..\..\.." -I"..\..\..\.." -I"..\..\..\..\orbsvcs" -I"..\lib" -DNDEBUG -DWIN64 -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -f "Makefile.RTCORBA_Baseline_Client.dep" "TestC.cpp" "client.cpp"
!ENDIF
...
"$(INTDIR)" :
	...
	if not exist "Release\RTCORBA_Baseline_Client\$(NULL)" mkdir "Release\RTCORBA_Baseline_Client"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
INTDIR=Static_Debug\RTCORBA_Baseline_Client\IA64
...
!IF "$(DEPGEN)" == ""
	...
	@echo http://www.ociweb.com/products/mpc/down.html
!ELSE
	$(DEPGEN) -I"..\..\..\..\.." -I"..\..\..\.." -I"..\..\..\..\orbsvcs" -I"..\lib" -D_DEBUG -DWIN64 -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -DACE_AS_STATIC_LIBS -DTAO_AS_STATIC_LIBS -f "Makefile.RTCORBA_Baseline_Client.dep" "TestC.cpp" "client.cpp"
!ENDIF
...
"$(INTDIR)" :
	...
	if not exist "Static_Debug\RTCORBA_Baseline_Client\$(NULL)" mkdir "Static_Debug\RTCORBA_Baseline_Client"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
INTDIR=Static_Release\RTCORBA_Baseline_Client\IA64
...
!IF "$(DEPGEN)" == ""
	...
	@echo http://www.ociweb.com/products/mpc/down.html
!ELSE
	$(DEPGEN) -I"..\..\..\..\.." -I"..\..\..\.." -I"..\..\..\..\orbsvcs" -I"..\lib" -DNDEBUG -DWIN64 -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -DACE_AS_STATIC_LIBS -DTAO_AS_STATIC_LIBS -f "Makefile.RTCORBA_Baseline_Client.dep" "TestC.cpp" "client.cpp"
!ENDIF
...
"$(INTDIR)" :
	...
	if not exist "Static_Release\RTCORBA_Baseline_Client\$(NULL)" mkdir "Static_Release\RTCORBA_Baseline_Client"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
!IF EXISTS("Makefile.RTCORBA_Baseline_Client.dep")
!INCLUDE "Makefile.RTCORBA_Baseline_Client.dep"
!ENDIF
!ENDIF
...
!IF "$(NO_EXTERNAL_DEPS)" != "1"
!IF EXISTS("Makefile.RTCORBA_Baseline_Client.dep")
	@echo Using "Makefile.RTCORBA_Baseline_Client.dep"
!ELSE
	@echo Warning: cannot find "Makefile.RTCORBA_Baseline_Client.dep"
!ENDIF
!ENDIF
