...
!MESSAGE
!MESSAGE NMAKE /f "Makefile.RTCORBA_Baseline_IDL.mak" CFG="Win64 Debug"
!MESSAGE
...
OUTDIR=.
INTDIR=Debug\RTCORBA_Baseline_IDL\IA64
...
"$(INTDIR)" :
	...
	if not exist "Debug\RTCORBA_Baseline_IDL\$(NULL)" mkdir "Debug\RTCORBA_Baseline_IDL"
...
OUTDIR=.
INTDIR=Release\RTCORBA_Baseline_IDL\IA64
...
"$(INTDIR)" :
	...
	if not exist "Release\RTCORBA_Baseline_IDL\$(NULL)" mkdir "Release\RTCORBA_Baseline_IDL"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
OUTDIR=.
INTDIR=Static_Debug\RTCORBA_Baseline_IDL\IA64
...
"$(INTDIR)" :
	...
	if not exist "Static_Debug\RTCORBA_Baseline_IDL\$(NULL)" mkdir "Static_Debug\RTCORBA_Baseline_IDL"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
OUTDIR=.
INTDIR=Static_Release\RTCORBA_Baseline_IDL\IA64
...
"$(INTDIR)" :
	...
	if not exist "Static_Release\RTCORBA_Baseline_IDL\$(NULL)" mkdir "Static_Release\RTCORBA_Baseline_IDL"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
!IF EXISTS("Makefile.RTCORBA_Baseline_IDL.dep")
!INCLUDE "Makefile.RTCORBA_Baseline_IDL.dep"
!ENDIF
!ENDIF
...
!IF "$(NO_EXTERNAL_DEPS)" != "1"
!IF EXISTS("Makefile.RTCORBA_Baseline_IDL.dep")
	@echo Using "Makefile.RTCORBA_Baseline_IDL.dep"
!ENDIF
!ENDIF
