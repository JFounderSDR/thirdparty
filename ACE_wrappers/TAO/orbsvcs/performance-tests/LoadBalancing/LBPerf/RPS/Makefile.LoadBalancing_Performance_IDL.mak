...
!MESSAGE
!MESSAGE NMAKE /f "Makefile.LoadBalancing_Performance_IDL.mak" CFG="Win64 Debug"
!MESSAGE
...
OUTDIR=.
INTDIR=Debug\LoadBalancing_Performance_IDL\IA64
...
"$(INTDIR)" :
	...
	if not exist "Debug\LoadBalancing_Performance_IDL\$(NULL)" mkdir "Debug\LoadBalancing_Performance_IDL"
...
OUTDIR=.
INTDIR=Release\LoadBalancing_Performance_IDL\IA64
...
"$(INTDIR)" :
	...
	if not exist "Release\LoadBalancing_Performance_IDL\$(NULL)" mkdir "Release\LoadBalancing_Performance_IDL"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
OUTDIR=.
INTDIR=Static_Debug\LoadBalancing_Performance_IDL\IA64
...
"$(INTDIR)" :
	...
	if not exist "Static_Debug\LoadBalancing_Performance_IDL\$(NULL)" mkdir "Static_Debug\LoadBalancing_Performance_IDL"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"

CPP=cl.exe
CPP_COMMON=/Zc:wchar_t /nologo /Wp64 /Ob0 /W3 /Gm /EHsc /Zi /GR /Gy /MDd /wd4355 /wd4250 /wd4290 /Fd".\sd.pdb" /I "..\..\..\..\..\.." /I "..\..\..\..\.." /I "..\..\..\..\..\orbsvcs" /D _DEBUG /D WIN64 /D WIN32 /D _WINDOWS /D _CRT_SECURE_NO_WARNINGS /D _CRT_SECURE_NO_DEPRECATE /D _CRT_NONSTDC_NO_DEPRECATE /D ACE_AS_STATIC_LIBS /D TAO_AS_STATIC_LIBS /D MPC_LIB_MODIFIER=\"sd\" /FD /c
...
OUTDIR=.
INTDIR=Static_Release\LoadBalancing_Performance_IDL\IA64
...
"$(INTDIR)" :
	...
	if not exist "Static_Release\LoadBalancing_Performance_IDL\$(NULL)" mkdir "Static_Release\LoadBalancing_Performance_IDL"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
!IF EXISTS("Makefile.LoadBalancing_Performance_IDL.dep")
!INCLUDE "Makefile.LoadBalancing_Performance_IDL.dep"
!ENDIF
!ENDIF
...
!IF "$(NO_EXTERNAL_DEPS)" != "1"
!IF EXISTS("Makefile.LoadBalancing_Performance_IDL.dep")
	@echo Using "Makefile.LoadBalancing_Performance_IDL.dep"
!ENDIF
!ENDIF
