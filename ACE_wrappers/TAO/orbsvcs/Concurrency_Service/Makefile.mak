...
all: Concurrency_Service

clean depend generated realclean $(CUSTOM_TARGETS):
	@echo Project: Makefile.Concurrency_Service.mak
	$(MAKE) /$(MAKEFLAGS) /f Makefile.Concurrency_Service.mak CFG="$(CFG)" $(@)

Concurrency_Service:
	@echo Project: Makefile.Concurrency_Service.mak
	$(MAKE) /$(MAKEFLAGS) /f Makefile.Concurrency_Service.mak CFG="$(CFG)" all
