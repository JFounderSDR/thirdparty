...
!MESSAGE
!MESSAGE NMAKE /f "Makefile.OfferSubscriptions_Idl.mak" CFG="Win64 Debug"
!MESSAGE
...
OUTDIR=.
INTDIR=Debug\OfferSubscriptions_Idl\IA64
...
"$(INTDIR)" :
	...
	if not exist "Debug\OfferSubscriptions_Idl\$(NULL)" mkdir "Debug\OfferSubscriptions_Idl"
...
OUTDIR=.
INTDIR=Release\OfferSubscriptions_Idl\IA64
...
"$(INTDIR)" :
	...
	if not exist "Release\OfferSubscriptions_Idl\$(NULL)" mkdir "Release\OfferSubscriptions_Idl"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
OUTDIR=.
INTDIR=Static_Debug\OfferSubscriptions_Idl\IA64
...
"$(INTDIR)" :
	...
	if not exist "Static_Debug\OfferSubscriptions_Idl\$(NULL)" mkdir "Static_Debug\OfferSubscriptions_Idl"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
OUTDIR=.
INTDIR=Static_Release\OfferSubscriptions_Idl\IA64
...
"$(INTDIR)" :
	...
	if not exist "Static_Release\OfferSubscriptions_Idl\$(NULL)" mkdir "Static_Release\OfferSubscriptions_Idl"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
!IF EXISTS("Makefile.OfferSubscriptions_Idl.dep")
!INCLUDE "Makefile.OfferSubscriptions_Idl.dep"
!ENDIF
!ENDIF
...
!IF "$(NO_EXTERNAL_DEPS)" != "1"
!IF EXISTS("Makefile.OfferSubscriptions_Idl.dep")
	@echo Using "Makefile.OfferSubscriptions_Idl.dep"
!ENDIF
!ENDIF
