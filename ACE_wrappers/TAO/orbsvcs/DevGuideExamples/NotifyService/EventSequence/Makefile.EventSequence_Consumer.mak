...
!MESSAGE
!MESSAGE NMAKE /f "Makefile.EventSequence_Consumer.mak" CFG="Win64 Debug"
!MESSAGE
...
OUTDIR=.
INSTALLDIR=.
INTDIR=Debug\EventSequence_Consumer\IA64
...
!ELSE
	$(DEPGEN) -I"..\..\..\..\.." -I"..\..\..\.." -I"..\..\..\..\orbsvcs" -D_DEBUG -DWIN64 -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -DTAO_HAS_TYPED_EVENT_CHANNEL -f "Makefile.EventSequence_Consumer.dep" "MessengerConsumer.cpp" "EventSequenceConsumer_i.cpp" "MessengerC.cpp" "MessengerS.cpp"
!ENDIF
...
"$(INTDIR)" :
	...
	if not exist "Debug\EventSequence_Consumer\$(NULL)" mkdir "Debug\EventSequence_Consumer"
...
LINK32_OBJS= \
	...
	"$(INTDIR)\EventSequenceConsumer_i.obj" \
...
OUTDIR=Release
INSTALLDIR=Release
INTDIR=Release\EventSequence_Consumer\IA64
...
!IF "$(DEPGEN)" == ""
	...
	@echo http://www.ociweb.com/products/mpc/down.html
!ELSE
	$(DEPGEN) -I"..\..\..\..\.." -I"..\..\..\.." -I"..\..\..\..\orbsvcs" -DNDEBUG -DWIN64 -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -DTAO_HAS_TYPED_EVENT_CHANNEL -f "Makefile.EventSequence_Consumer.dep" "MessengerConsumer.cpp" "EventSequenceConsumer_i.cpp" "MessengerC.cpp" "MessengerS.cpp"
!ENDIF
...
"$(INTDIR)" :
	...
	if not exist "Release\EventSequence_Consumer\$(NULL)" mkdir "Release\EventSequence_Consumer"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
INTDIR=Static_Debug\EventSequence_Consumer\IA64
...
"$(INTDIR)" :
	...
	if not exist "Static_Debug\EventSequence_Consumer\$(NULL)" mkdir "Static_Debug\EventSequence_Consumer"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
INTDIR=Static_Release\EventSequence_Consumer\IA64
...
"$(INTDIR)" :
	...
	if not exist "Static_Release\EventSequence_Consumer\$(NULL)" mkdir "Static_Release\EventSequence_Consumer"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
!IF EXISTS("Makefile.EventSequence_Consumer.dep")
!INCLUDE "Makefile.EventSequence_Consumer.dep"
!ENDIF
!ENDIF
...
SOURCE="EventSequenceConsumer_i.cpp"

"$(INTDIR)\EventSequenceConsumer_i.obj" : $(SOURCE)
	$(CPP) $(CPP_COMMON) /Fo"$(INTDIR)\EventSequenceConsumer_i.obj" $(SOURCE)
...
!IF "$(NO_EXTERNAL_DEPS)" != "1"
!IF EXISTS("Makefile.EventSequence_Consumer.dep")
	@echo Using "Makefile.EventSequence_Consumer.dep"
!ELSE
	@echo Warning: cannot find "Makefile.EventSequence_Consumer.dep"
!ENDIF
!ENDIF
