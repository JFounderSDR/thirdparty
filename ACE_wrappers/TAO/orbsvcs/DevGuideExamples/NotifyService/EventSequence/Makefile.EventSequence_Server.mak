...
!MESSAGE
!MESSAGE NMAKE /f "Makefile.EventSequence_Server.mak" CFG="Win64 Debug"
!MESSAGE
...
OUTDIR=.
INSTALLDIR=.
INTDIR=Debug\EventSequence_Server\IA64
...
!ELSE
	$(DEPGEN) -I"..\..\..\..\.." -I"..\..\..\.." -I"..\..\..\..\orbsvcs" -D_DEBUG -DWIN64 -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -DTAO_HAS_TYPED_EVENT_CHANNEL -f "Makefile.EventSequence_Server.dep" "EventSequenceSupplier_i.cpp" "MessengerServer.cpp" "Messenger_i.cpp" "MessengerC.cpp" "MessengerS.cpp"
!ENDIF
...
"$(INTDIR)" :
	...
	if not exist "Debug\EventSequence_Server\$(NULL)" mkdir "Debug\EventSequence_Server"
...
LINK32=link.exe
LINK32_FLAGS=advapi32.lib user32.lib /INCREMENTAL:NO ACEd.lib TAOd.lib TAO_AnyTypeCoded.lib TAO_PortableServerd.lib TAO_CosEventd.lib TAO_CosNotificationd.lib TAO_CosEvent_Skeld.lib TAO_CosNotification_Skeld.lib TAO_CosNamingd.lib /libpath:"." /libpath:"..\..\..\..\..\lib" /nologo /subsystem:console /debug /pdb:"$(INSTALLDIR)\MessengerServer.pdb" /machine:IA64 /out:"$(INSTALLDIR)\MessengerServer.exe"
LINK32_OBJS= \
	"$(INTDIR)\EventSequenceSupplier_i.obj" \
...
OUTDIR=Release
INSTALLDIR=Release
INTDIR=Release\EventSequence_Server\IA64
...
!IF "$(DEPGEN)" == ""
	...
	@echo http://www.ociweb.com/products/mpc/down.html
!ELSE
	$(DEPGEN) -I"..\..\..\..\.." -I"..\..\..\.." -I"..\..\..\..\orbsvcs" -DNDEBUG -DWIN64 -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -DTAO_HAS_TYPED_EVENT_CHANNEL -f "Makefile.EventSequence_Server.dep" "EventSequenceSupplier_i.cpp" "MessengerServer.cpp" "Messenger_i.cpp" "MessengerC.cpp" "MessengerS.cpp"
!ENDIF
...
"$(INTDIR)" :
	...
	if not exist "Release\EventSequence_Server\$(NULL)" mkdir "Release\EventSequence_Server"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
LINK32=link.exe
LINK32_FLAGS=advapi32.lib user32.lib /INCREMENTAL:NO ACE.lib TAO.lib TAO_AnyTypeCode.lib TAO_PortableServer.lib TAO_CosEvent.lib TAO_CosNotification.lib TAO_CosEvent_Skel.lib TAO_CosNotification_Skel.lib TAO_CosNaming.lib /libpath:"." /libpath:"..\..\..\..\..\lib" /nologo /subsystem:console  /machine:IA64 /out:"$(INSTALLDIR)\MessengerServer.exe"
LINK32_OBJS= \
	"$(INTDIR)\EventSequenceSupplier_i.obj" \
	"$(INTDIR)\MessengerServer.obj" \
	"$(INTDIR)\Messenger_i.obj" \
...
INTDIR=Static_Debug\EventSequence_Server\IA64
...
"$(INTDIR)" :
	...
	if not exist "Static_Debug\EventSequence_Server\$(NULL)" mkdir "Static_Debug\EventSequence_Server"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
LINK32=link.exe
LINK32_FLAGS=advapi32.lib user32.lib /INCREMENTAL:NO ACEsd.lib TAOsd.lib TAO_AnyTypeCodesd.lib TAO_PortableServersd.lib TAO_CosEventsd.lib TAO_CosNotificationsd.lib TAO_CosEvent_Skelsd.lib TAO_CosNotification_Skelsd.lib TAO_CosNamingsd.lib /libpath:"." /libpath:"..\..\..\..\..\lib" /nologo /subsystem:console /debug /pdb:"$(INSTALLDIR)\MessengerServer.pdb" /machine:IA64 /out:"$(INSTALLDIR)\MessengerServer.exe"
LINK32_OBJS= \
	"$(INTDIR)\EventSequenceSupplier_i.obj" \
	"$(INTDIR)\MessengerServer.obj" \
	"$(INTDIR)\Messenger_i.obj" \
...
INTDIR=Static_Release\EventSequence_Server\IA64
...
"$(INTDIR)" :
	...
	if not exist "Static_Release\EventSequence_Server\$(NULL)" mkdir "Static_Release\EventSequence_Server"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
LINK32=link.exe
LINK32_FLAGS=advapi32.lib user32.lib /INCREMENTAL:NO ACEs.lib TAOs.lib TAO_AnyTypeCodes.lib TAO_PortableServers.lib TAO_CosEvents.lib TAO_CosNotifications.lib TAO_CosEvent_Skels.lib TAO_CosNotification_Skels.lib TAO_CosNamings.lib /libpath:"." /libpath:"..\..\..\..\..\lib" /nologo /subsystem:console  /machine:IA64 /out:"$(INSTALLDIR)\MessengerServer.exe"
LINK32_OBJS= \
	"$(INTDIR)\EventSequenceSupplier_i.obj" \
	"$(INTDIR)\MessengerServer.obj" \
	"$(INTDIR)\Messenger_i.obj" \
...
!IF EXISTS("Makefile.EventSequence_Server.dep")
!INCLUDE "Makefile.EventSequence_Server.dep"
!ENDIF
!ENDIF

!IF "$(CFG)" == "Win64 Debug" || "$(CFG)" == "Win64 Release" || "$(CFG)" == "Win64 Static Debug" || "$(CFG)" == "Win64 Static Release" 
SOURCE="EventSequenceSupplier_i.cpp"

"$(INTDIR)\EventSequenceSupplier_i.obj" : $(SOURCE)
	$(CPP) $(CPP_COMMON) /Fo"$(INTDIR)\EventSequenceSupplier_i.obj" $(SOURCE)
...
!IF "$(NO_EXTERNAL_DEPS)" != "1"
!IF EXISTS("Makefile.EventSequence_Server.dep")
	@echo Using "Makefile.EventSequence_Server.dep"
!ELSE
	@echo Warning: cannot find "Makefile.EventSequence_Server.dep"
!ENDIF
!ENDIF
