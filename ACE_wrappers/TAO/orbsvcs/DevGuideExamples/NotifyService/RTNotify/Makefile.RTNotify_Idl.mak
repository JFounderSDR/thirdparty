...
!MESSAGE
!MESSAGE NMAKE /f "Makefile.RTNotify_Idl.mak" CFG="Win64 Debug"
!MESSAGE
...
OUTDIR=.
INTDIR=Debug\RTNotify_Idl\IA64
...
"$(INTDIR)" :
	...
	if not exist "Debug\RTNotify_Idl\$(NULL)" mkdir "Debug\RTNotify_Idl"
...
OUTDIR=.
INTDIR=Release\RTNotify_Idl\IA64
...
"$(INTDIR)" :
	...
	if not exist "Release\RTNotify_Idl\$(NULL)" mkdir "Release\RTNotify_Idl"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
OUTDIR=.
INTDIR=Static_Debug\RTNotify_Idl\IA64
...
"$(INTDIR)" :
	...
	if not exist "Static_Debug\RTNotify_Idl\$(NULL)" mkdir "Static_Debug\RTNotify_Idl"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
OUTDIR=.
INTDIR=Static_Release\RTNotify_Idl\IA64
...
"$(INTDIR)" :
	...
	if not exist "Static_Release\RTNotify_Idl\$(NULL)" mkdir "Static_Release\RTNotify_Idl"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
!IF EXISTS("Makefile.RTNotify_Idl.dep")
!INCLUDE "Makefile.RTNotify_Idl.dep"
!ENDIF
!ENDIF
...
!IF "$(NO_EXTERNAL_DEPS)" != "1"
!IF EXISTS("Makefile.RTNotify_Idl.dep")
	@echo Using "Makefile.RTNotify_Idl.dep"
!ENDIF
!ENDIF
