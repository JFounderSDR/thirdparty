...
!MESSAGE
!MESSAGE NMAKE /f "Makefile.RTNotify_Consumer.mak" CFG="Win64 Debug"
!MESSAGE
...
OUTDIR=.
INSTALLDIR=.
INTDIR=Debug\RTNotify_Consumer\IA64
...
!ELSE
	$(DEPGEN) -I"..\..\..\..\.." -I"..\..\..\.." -I"..\..\..\..\orbsvcs" -D_DEBUG -DWIN64 -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -DTAO_HAS_TYPED_EVENT_CHANNEL -f "Makefile.RTNotify_Consumer.dep" "MessengerConsumer.cpp" "StructuredEventConsumer_i.cpp" "MessengerC.cpp" "MessengerS.cpp"
!ENDIF
...
"$(INTDIR)" :
	...
	if not exist "Debug\RTNotify_Consumer\$(NULL)" mkdir "Debug\RTNotify_Consumer"
...
OUTDIR=Release
INSTALLDIR=Release
INTDIR=Release\RTNotify_Consumer\IA64
...
!IF "$(DEPGEN)" == ""
	...
	@echo http://www.ociweb.com/products/mpc/down.html
!ELSE
	$(DEPGEN) -I"..\..\..\..\.." -I"..\..\..\.." -I"..\..\..\..\orbsvcs" -DNDEBUG -DWIN64 -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -DTAO_HAS_TYPED_EVENT_CHANNEL -f "Makefile.RTNotify_Consumer.dep" "MessengerConsumer.cpp" "StructuredEventConsumer_i.cpp" "MessengerC.cpp" "MessengerS.cpp"
!ENDIF
...
"$(INTDIR)" :
	...
	if not exist "Release\RTNotify_Consumer\$(NULL)" mkdir "Release\RTNotify_Consumer"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
INTDIR=Static_Debug\RTNotify_Consumer\IA64
...
"$(INTDIR)" :
	...
	if not exist "Static_Debug\RTNotify_Consumer\$(NULL)" mkdir "Static_Debug\RTNotify_Consumer"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
INTDIR=Static_Release\RTNotify_Consumer\IA64
...
"$(INTDIR)" :
	...
	if not exist "Static_Release\RTNotify_Consumer\$(NULL)" mkdir "Static_Release\RTNotify_Consumer"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
LINK32=link.exe
LINK32_FLAGS=advapi32.lib user32.lib /INCREMENTAL:NO ACEs.lib TAOs.lib TAO_AnyTypeCodes.lib TAO_PortableServers.lib TAO_CosNamings.lib TAO_CosEvents.lib TAO_CosNotifications.lib TAO_CosEvent_Skels.lib TAO_CosNotification_Skels.lib TAO_CodecFactorys.lib TAO_PIs.lib TAO_RTCORBAs.lib TAO_RTPortableServers.lib /libpath:"." /libpath:"..\..\..\..\..\lib" /nologo /subsystem:console  /machine:IA64 /out:"$(INSTALLDIR)\MessengerConsumer.exe"
LINK32_OBJS= \
	"$(INTDIR)\MessengerConsumer.obj" \
	"$(INTDIR)\StructuredEventConsumer_i.obj" \
	"$(INTDIR)\MessengerC.obj" \
...
!IF EXISTS("Makefile.RTNotify_Consumer.dep")
!INCLUDE "Makefile.RTNotify_Consumer.dep"
!ENDIF
!ENDIF
...
!IF "$(NO_EXTERNAL_DEPS)" != "1"
!IF EXISTS("Makefile.RTNotify_Consumer.dep")
	@echo Using "Makefile.RTNotify_Consumer.dep"
!ELSE
	@echo Warning: cannot find "Makefile.RTNotify_Consumer.dep"
!ENDIF
!ENDIF
