...
!MESSAGE
!MESSAGE NMAKE /f "Makefile.RTNotify_Server.mak" CFG="Win64 Debug"
!MESSAGE
...
OUTDIR=.
INSTALLDIR=.
INTDIR=Debug\RTNotify_Server\IA64
...
!ELSE
	$(DEPGEN) -I"..\..\..\..\.." -I"..\..\..\.." -I"..\..\..\..\orbsvcs" -D_DEBUG -DWIN64 -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -DTAO_HAS_TYPED_EVENT_CHANNEL -f "Makefile.RTNotify_Server.dep" "StructuredEventSupplier_i.cpp" "MessengerServer.cpp" "Messenger_i.cpp" "MessengerC.cpp" "MessengerS.cpp"
!ENDIF
...
"$(INTDIR)" :
	...
	if not exist "Debug\RTNotify_Server\$(NULL)" mkdir "Debug\RTNotify_Server"
...
OUTDIR=Release
INSTALLDIR=Release
INTDIR=Release\RTNotify_Server\IA64
...
!IF "$(DEPGEN)" == ""
	...
	@echo http://www.ociweb.com/products/mpc/down.html
!ELSE
	$(DEPGEN) -I"..\..\..\..\.." -I"..\..\..\.." -I"..\..\..\..\orbsvcs" -DNDEBUG -DWIN64 -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -DTAO_HAS_TYPED_EVENT_CHANNEL -f "Makefile.RTNotify_Server.dep" "StructuredEventSupplier_i.cpp" "MessengerServer.cpp" "Messenger_i.cpp" "MessengerC.cpp" "MessengerS.cpp"
!ENDIF
...
"$(INTDIR)" :
	...
	if not exist "Release\RTNotify_Server\$(NULL)" mkdir "Release\RTNotify_Server"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
INTDIR=Static_Debug\RTNotify_Server\IA64
...
"$(INTDIR)" :
	...
	if not exist "Static_Debug\RTNotify_Server\$(NULL)" mkdir "Static_Debug\RTNotify_Server"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
LINK32=link.exe
LINK32_FLAGS=advapi32.lib user32.lib /INCREMENTAL:NO ACEsd.lib TAOsd.lib TAO_AnyTypeCodesd.lib TAO_PortableServersd.lib TAO_CosNamingsd.lib TAO_CosEventsd.lib TAO_CosNotificationsd.lib TAO_CosEvent_Skelsd.lib TAO_CosNotification_Skelsd.lib TAO_CodecFactorysd.lib TAO_PIsd.lib TAO_RTCORBAsd.lib /libpath:"." /libpath:"..\..\..\..\..\lib" /nologo /subsystem:console /debug /pdb:"$(INSTALLDIR)\MessengerServer.pdb" /machine:IA64 /out:"$(INSTALLDIR)\MessengerServer.exe"
LINK32_OBJS= \
	"$(INTDIR)\StructuredEventSupplier_i.obj" \
	"$(INTDIR)\MessengerServer.obj" \
	"$(INTDIR)\Messenger_i.obj" \
...
INTDIR=Static_Release\RTNotify_Server\IA64
...
"$(INTDIR)" :
	...
	if not exist "Static_Release\RTNotify_Server\$(NULL)" mkdir "Static_Release\RTNotify_Server"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
!IF EXISTS("Makefile.RTNotify_Server.dep")
!INCLUDE "Makefile.RTNotify_Server.dep"
!ENDIF
!ENDIF
...
!IF "$(NO_EXTERNAL_DEPS)" != "1"
!IF EXISTS("Makefile.RTNotify_Server.dep")
	@echo Using "Makefile.RTNotify_Server.dep"
!ELSE
	@echo Warning: cannot find "Makefile.RTNotify_Server.dep"
!ENDIF
!ENDIF
