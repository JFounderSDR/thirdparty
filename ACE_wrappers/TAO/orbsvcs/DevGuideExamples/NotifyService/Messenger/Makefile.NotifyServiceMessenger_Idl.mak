...
!MESSAGE
!MESSAGE NMAKE /f "Makefile.NotifyServiceMessenger_Idl.mak" CFG="Win64 Debug"
!MESSAGE
...
OUTDIR=.
INTDIR=Debug\NotifyServiceMessenger_Idl\IA64
...
"$(INTDIR)" :
	...
	if not exist "Debug\NotifyServiceMessenger_Idl\$(NULL)" mkdir "Debug\NotifyServiceMessenger_Idl"
...
OUTDIR=.
INTDIR=Release\NotifyServiceMessenger_Idl\IA64
...
"$(INTDIR)" :
	...
	if not exist "Release\NotifyServiceMessenger_Idl\$(NULL)" mkdir "Release\NotifyServiceMessenger_Idl"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
OUTDIR=.
INTDIR=Static_Debug\NotifyServiceMessenger_Idl\IA64
...
"$(INTDIR)" :
	...
	if not exist "Static_Debug\NotifyServiceMessenger_Idl\$(NULL)" mkdir "Static_Debug\NotifyServiceMessenger_Idl"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
OUTDIR=.
INTDIR=Static_Release\NotifyServiceMessenger_Idl\IA64
...
"$(INTDIR)" :
	...
	if not exist "Static_Release\NotifyServiceMessenger_Idl\$(NULL)" mkdir "Static_Release\NotifyServiceMessenger_Idl"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
!IF EXISTS("Makefile.NotifyServiceMessenger_Idl.dep")
!INCLUDE "Makefile.NotifyServiceMessenger_Idl.dep"
!ENDIF
!ENDIF
...
!IF "$(NO_EXTERNAL_DEPS)" != "1"
!IF EXISTS("Makefile.NotifyServiceMessenger_Idl.dep")
	@echo Using "Makefile.NotifyServiceMessenger_Idl.dep"
!ENDIF
!ENDIF
