...
!MESSAGE
!MESSAGE NMAKE /f "Makefile.NotifyServiceMessenger_Consumer.mak" CFG="Win64 Debug"
!MESSAGE
...
OUTDIR=.
INSTALLDIR=.
INTDIR=Debug\NotifyServiceMessenger_Consumer\IA64
...
!ELSE
	$(DEPGEN) -I"..\..\..\..\.." -I"..\..\..\.." -I"..\..\..\..\orbsvcs" -D_DEBUG -DWIN64 -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -DTAO_HAS_TYPED_EVENT_CHANNEL -f "Makefile.NotifyServiceMessenger_Consumer.dep" "MessengerConsumer.cpp" "StructuredEventConsumer_i.cpp" "MessengerC.cpp" "MessengerS.cpp"
!ENDIF
...
"$(INTDIR)" :
	...
	if not exist "Debug\NotifyServiceMessenger_Consumer\$(NULL)" mkdir "Debug\NotifyServiceMessenger_Consumer"
...
OUTDIR=Release
INSTALLDIR=Release
INTDIR=Release\NotifyServiceMessenger_Consumer\IA64
...
!IF "$(DEPGEN)" == ""
	...
	@echo http://www.ociweb.com/products/mpc/down.html
!ELSE
	$(DEPGEN) -I"..\..\..\..\.." -I"..\..\..\.." -I"..\..\..\..\orbsvcs" -DNDEBUG -DWIN64 -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -DTAO_HAS_TYPED_EVENT_CHANNEL -f "Makefile.NotifyServiceMessenger_Consumer.dep" "MessengerConsumer.cpp" "StructuredEventConsumer_i.cpp" "MessengerC.cpp" "MessengerS.cpp"
!ENDIF
...
"$(INTDIR)" :
	...
	if not exist "Release\NotifyServiceMessenger_Consumer\$(NULL)" mkdir "Release\NotifyServiceMessenger_Consumer"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
INTDIR=Static_Debug\NotifyServiceMessenger_Consumer\IA64
...
"$(INTDIR)" :
	...
	if not exist "Static_Debug\NotifyServiceMessenger_Consumer\$(NULL)" mkdir "Static_Debug\NotifyServiceMessenger_Consumer"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
INTDIR=Static_Release\NotifyServiceMessenger_Consumer\IA64
...
"$(INTDIR)" :
	...
	if not exist "Static_Release\NotifyServiceMessenger_Consumer\$(NULL)" mkdir "Static_Release\NotifyServiceMessenger_Consumer"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
!IF EXISTS("Makefile.NotifyServiceMessenger_Consumer.dep")
!INCLUDE "Makefile.NotifyServiceMessenger_Consumer.dep"
!ENDIF
!ENDIF
...
!IF "$(NO_EXTERNAL_DEPS)" != "1"
!IF EXISTS("Makefile.NotifyServiceMessenger_Consumer.dep")
	@echo Using "Makefile.NotifyServiceMessenger_Consumer.dep"
!ELSE
	@echo Warning: cannot find "Makefile.NotifyServiceMessenger_Consumer.dep"
!ENDIF
!ENDIF
