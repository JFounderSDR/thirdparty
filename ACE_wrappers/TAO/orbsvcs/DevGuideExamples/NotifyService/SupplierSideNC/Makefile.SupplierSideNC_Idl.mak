...
!MESSAGE
!MESSAGE NMAKE /f "Makefile.SupplierSideNC_Idl.mak" CFG="Win64 Debug"
!MESSAGE
...
OUTDIR=.
INTDIR=Debug\SupplierSideNC_Idl\IA64
...
"$(INTDIR)" :
	...
	if not exist "Debug\SupplierSideNC_Idl\$(NULL)" mkdir "Debug\SupplierSideNC_Idl"
...
OUTDIR=.
INTDIR=Release\SupplierSideNC_Idl\IA64
...
"$(INTDIR)" :
	...
	if not exist "Release\SupplierSideNC_Idl\$(NULL)" mkdir "Release\SupplierSideNC_Idl"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
OUTDIR=.
INTDIR=Static_Debug\SupplierSideNC_Idl\IA64
...
"$(INTDIR)" :
	...
	if not exist "Static_Debug\SupplierSideNC_Idl\$(NULL)" mkdir "Static_Debug\SupplierSideNC_Idl"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
OUTDIR=.
INTDIR=Static_Release\SupplierSideNC_Idl\IA64
...
"$(INTDIR)" :
	...
	if not exist "Static_Release\SupplierSideNC_Idl\$(NULL)" mkdir "Static_Release\SupplierSideNC_Idl"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
!IF EXISTS("Makefile.SupplierSideNC_Idl.dep")
!INCLUDE "Makefile.SupplierSideNC_Idl.dep"
!ENDIF
!ENDIF
...
!IF "$(NO_EXTERNAL_DEPS)" != "1"
!IF EXISTS("Makefile.SupplierSideNC_Idl.dep")
	@echo Using "Makefile.SupplierSideNC_Idl.dep"
!ENDIF
!ENDIF
