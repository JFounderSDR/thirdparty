...
!MESSAGE
!MESSAGE NMAKE /f "Makefile.SupplierSideNC_Server.mak" CFG="Win64 Debug"
!MESSAGE
...
OUTDIR=.
INSTALLDIR=.
INTDIR=Debug\SupplierSideNC_Server\IA64
...
!ELSE
	$(DEPGEN) -I"..\..\..\..\.." -I"..\..\..\.." -I"..\..\..\..\orbsvcs" -D_DEBUG -DWIN64 -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -DTAO_HAS_TYPED_EVENT_CHANNEL -f "Makefile.SupplierSideNC_Server.dep" "StructuredEventSupplier_i.cpp" "MessengerServer.cpp" "Messenger_i.cpp" "MessengerC.cpp" "MessengerS.cpp"
!ENDIF
...
"$(INTDIR)" :
	...
	if not exist "Debug\SupplierSideNC_Server\$(NULL)" mkdir "Debug\SupplierSideNC_Server"
...
OUTDIR=Release
INSTALLDIR=Release
INTDIR=Release\SupplierSideNC_Server\IA64
...
!IF "$(DEPGEN)" == ""
	...
	@echo http://www.ociweb.com/products/mpc/down.html
!ELSE
	$(DEPGEN) -I"..\..\..\..\.." -I"..\..\..\.." -I"..\..\..\..\orbsvcs" -DNDEBUG -DWIN64 -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -DTAO_HAS_TYPED_EVENT_CHANNEL -f "Makefile.SupplierSideNC_Server.dep" "StructuredEventSupplier_i.cpp" "MessengerServer.cpp" "Messenger_i.cpp" "MessengerC.cpp" "MessengerS.cpp"
!ENDIF
...
"$(INTDIR)" :
	...
	if not exist "Release\SupplierSideNC_Server\$(NULL)" mkdir "Release\SupplierSideNC_Server"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
INTDIR=Static_Debug\SupplierSideNC_Server\IA64
...
"$(INTDIR)" :
	...
	if not exist "Static_Debug\SupplierSideNC_Server\$(NULL)" mkdir "Static_Debug\SupplierSideNC_Server"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
INTDIR=Static_Release\SupplierSideNC_Server\IA64
...
"$(INTDIR)" :
	...
	if not exist "Static_Release\SupplierSideNC_Server\$(NULL)" mkdir "Static_Release\SupplierSideNC_Server"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
!IF EXISTS("Makefile.SupplierSideNC_Server.dep")
!INCLUDE "Makefile.SupplierSideNC_Server.dep"
!ENDIF
!ENDIF
...
!IF "$(NO_EXTERNAL_DEPS)" != "1"
!IF EXISTS("Makefile.SupplierSideNC_Server.dep")
	@echo Using "Makefile.SupplierSideNC_Server.dep"
!ELSE
	@echo Warning: cannot find "Makefile.SupplierSideNC_Server.dep"
!ENDIF
!ENDIF
