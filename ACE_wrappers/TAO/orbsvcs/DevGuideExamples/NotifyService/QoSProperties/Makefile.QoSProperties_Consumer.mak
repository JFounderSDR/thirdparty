...
!MESSAGE
!MESSAGE NMAKE /f "Makefile.QoSProperties_Consumer.mak" CFG="Win64 Debug"
!MESSAGE
...
OUTDIR=.
INSTALLDIR=.
INTDIR=Debug\QoSProperties_Consumer\IA64
...
!ELSE
	$(DEPGEN) -I"..\..\..\..\.." -I"..\..\..\.." -I"..\..\..\..\orbsvcs" -D_DEBUG -DWIN64 -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -DTAO_HAS_TYPED_EVENT_CHANNEL -f "Makefile.QoSProperties_Consumer.dep" "MessengerConsumer.cpp" "StructuredEventConsumer_i.cpp" "MessengerC.cpp" "MessengerS.cpp"
!ENDIF
...
"$(INTDIR)" :
	...
	if not exist "Debug\QoSProperties_Consumer\$(NULL)" mkdir "Debug\QoSProperties_Consumer"
...
OUTDIR=Release
INSTALLDIR=Release
INTDIR=Release\QoSProperties_Consumer\IA64
...
!IF "$(DEPGEN)" == ""
	...
	@echo http://www.ociweb.com/products/mpc/down.html
!ELSE
	$(DEPGEN) -I"..\..\..\..\.." -I"..\..\..\.." -I"..\..\..\..\orbsvcs" -DNDEBUG -DWIN64 -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -DTAO_HAS_TYPED_EVENT_CHANNEL -f "Makefile.QoSProperties_Consumer.dep" "MessengerConsumer.cpp" "StructuredEventConsumer_i.cpp" "MessengerC.cpp" "MessengerS.cpp"
!ENDIF
...
"$(INTDIR)" :
	...
	if not exist "Release\QoSProperties_Consumer\$(NULL)" mkdir "Release\QoSProperties_Consumer"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
INTDIR=Static_Debug\QoSProperties_Consumer\IA64
...
!IF "$(DEPGEN)" == ""
	...
	@echo http://www.ociweb.com/products/mpc/down.html
!ELSE
	$(DEPGEN) -I"..\..\..\..\.." -I"..\..\..\.." -I"..\..\..\..\orbsvcs" -D_DEBUG -DWIN64 -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -DTAO_HAS_TYPED_EVENT_CHANNEL -DACE_AS_STATIC_LIBS -DTAO_AS_STATIC_LIBS -f "Makefile.QoSProperties_Consumer.dep" "MessengerConsumer.cpp" "StructuredEventConsumer_i.cpp" "MessengerC.cpp" "MessengerS.cpp"
!ENDIF
...
"$(INTDIR)" :
	...
	if not exist "Static_Debug\QoSProperties_Consumer\$(NULL)" mkdir "Static_Debug\QoSProperties_Consumer"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
INTDIR=Static_Release\QoSProperties_Consumer\IA64
...
"$(INTDIR)" :
	...
	if not exist "Static_Release\QoSProperties_Consumer\$(NULL)" mkdir "Static_Release\QoSProperties_Consumer"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
!IF EXISTS("Makefile.QoSProperties_Consumer.dep")
!INCLUDE "Makefile.QoSProperties_Consumer.dep"
!ENDIF
!ENDIF
...
!IF "$(NO_EXTERNAL_DEPS)" != "1"
!IF EXISTS("Makefile.QoSProperties_Consumer.dep")
	@echo Using "Makefile.QoSProperties_Consumer.dep"
!ELSE
	@echo Warning: cannot find "Makefile.QoSProperties_Consumer.dep"
!ENDIF
!ENDIF
