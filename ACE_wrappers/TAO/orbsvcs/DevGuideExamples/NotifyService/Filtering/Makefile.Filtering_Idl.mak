...
!MESSAGE
!MESSAGE NMAKE /f "Makefile.Filtering_Idl.mak" CFG="Win64 Debug"
!MESSAGE
...
OUTDIR=.
INTDIR=Debug\Filtering_Idl\IA64
...
"$(INTDIR)" :
	...
	if not exist "Debug\Filtering_Idl\$(NULL)" mkdir "Debug\Filtering_Idl"
...
OUTDIR=.
INTDIR=Release\Filtering_Idl\IA64
...
"$(INTDIR)" :
	...
	if not exist "Release\Filtering_Idl\$(NULL)" mkdir "Release\Filtering_Idl"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
OUTDIR=.
INTDIR=Static_Debug\Filtering_Idl\IA64
...
"$(INTDIR)" :
	...
	if not exist "Static_Debug\Filtering_Idl\$(NULL)" mkdir "Static_Debug\Filtering_Idl"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
OUTDIR=.
INTDIR=Static_Release\Filtering_Idl\IA64
...
"$(INTDIR)" :
	...
	if not exist "Static_Release\Filtering_Idl\$(NULL)" mkdir "Static_Release\Filtering_Idl"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
!IF EXISTS("Makefile.Filtering_Idl.dep")
!INCLUDE "Makefile.Filtering_Idl.dep"
!ENDIF
!ENDIF
...
!IF "$(NO_EXTERNAL_DEPS)" != "1"
!IF EXISTS("Makefile.Filtering_Idl.dep")
	@echo Using "Makefile.Filtering_Idl.dep"
!ENDIF
!ENDIF
