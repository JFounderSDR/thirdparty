...
!MESSAGE
!MESSAGE NMAKE /f "Makefile.Notify_Supplier.mak" CFG="Win64 Debug"
!MESSAGE
...
OUTDIR=.
INSTALLDIR=.
INTDIR=Debug\Notify_Supplier\IA64
...
!ELSE
	$(DEPGEN) -I"..\..\..\..\.." -I"..\..\..\.." -I"..\..\..\..\orbsvcs" -D_DEBUG -DWIN64 -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -DTAO_HAS_TYPED_EVENT_CHANNEL -f "Makefile.Notify_Supplier.dep" "EventC.cpp" "EventS.cpp" "supplier.cpp"
!ENDIF
...
"$(INTDIR)" :
	...
	if not exist "Debug\Notify_Supplier\$(NULL)" mkdir "Debug\Notify_Supplier"
...
OUTDIR=Release
INSTALLDIR=Release
INTDIR=Release\Notify_Supplier\IA64
...
!IF "$(DEPGEN)" == ""
	...
	@echo http://www.ociweb.com/products/mpc/down.html
!ELSE
	$(DEPGEN) -I"..\..\..\..\.." -I"..\..\..\.." -I"..\..\..\..\orbsvcs" -DNDEBUG -DWIN64 -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -DTAO_HAS_TYPED_EVENT_CHANNEL -f "Makefile.Notify_Supplier.dep" "EventC.cpp" "EventS.cpp" "supplier.cpp"
!ENDIF
...
"$(INTDIR)" :
	...
	if not exist "Release\Notify_Supplier\$(NULL)" mkdir "Release\Notify_Supplier"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
LINK32=link.exe
LINK32_FLAGS=advapi32.lib user32.lib /INCREMENTAL:NO ACE.lib TAO.lib TAO_AnyTypeCode.lib TAO_PortableServer.lib TAO_Valuetype.lib TAO_CosEvent.lib TAO_CosNotification.lib TAO_CosEvent_Skel.lib /libpath:"." /libpath:"..\..\..\..\..\lib" /nologo /subsystem:console  /machine:IA64 /out:"$(INSTALLDIR)\supplier.exe"
LINK32_OBJS= \
	"$(INTDIR)\EventC.obj" \
	"$(INTDIR)\EventS.obj" \
	"$(INTDIR)\supplier.obj"
...
INTDIR=Static_Debug\Notify_Supplier\IA64
...
!IF "$(DEPGEN)" == ""
	...
	@echo http://www.ociweb.com/products/mpc/down.html
!ELSE
	$(DEPGEN) -I"..\..\..\..\.." -I"..\..\..\.." -I"..\..\..\..\orbsvcs" -D_DEBUG -DWIN64 -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -DTAO_HAS_TYPED_EVENT_CHANNEL -DACE_AS_STATIC_LIBS -DTAO_AS_STATIC_LIBS -f "Makefile.Notify_Supplier.dep" "EventC.cpp" "EventS.cpp" "supplier.cpp"
!ENDIF
...
"$(INTDIR)" :
	...
	if not exist "Static_Debug\Notify_Supplier\$(NULL)" mkdir "Static_Debug\Notify_Supplier"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
INTDIR=Static_Release\Notify_Supplier\IA64
...
!IF "$(DEPGEN)" == ""
	...
	@echo http://www.ociweb.com/products/mpc/down.html
!ELSE
	$(DEPGEN) -I"..\..\..\..\.." -I"..\..\..\.." -I"..\..\..\..\orbsvcs" -DNDEBUG -DWIN64 -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -DTAO_HAS_TYPED_EVENT_CHANNEL -DACE_AS_STATIC_LIBS -DTAO_AS_STATIC_LIBS -f "Makefile.Notify_Supplier.dep" "EventC.cpp" "EventS.cpp" "supplier.cpp"
!ENDIF
...
"$(INTDIR)" :
	...
	if not exist "Static_Release\Notify_Supplier\$(NULL)" mkdir "Static_Release\Notify_Supplier"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
LINK32=link.exe
LINK32_FLAGS=advapi32.lib user32.lib /INCREMENTAL:NO ACEs.lib TAOs.lib TAO_AnyTypeCodes.lib TAO_PortableServers.lib TAO_Valuetypes.lib TAO_CosEvents.lib TAO_CosNotifications.lib TAO_CosEvent_Skels.lib /libpath:"." /libpath:"..\..\..\..\..\lib" /nologo /subsystem:console  /machine:IA64 /out:"$(INSTALLDIR)\supplier.exe"
LINK32_OBJS= \
	"$(INTDIR)\EventC.obj" \
	"$(INTDIR)\EventS.obj" \
	"$(INTDIR)\supplier.obj"
...
!IF EXISTS("Makefile.Notify_Supplier.dep")
!INCLUDE "Makefile.Notify_Supplier.dep"
!ENDIF
!ENDIF
...
!IF "$(NO_EXTERNAL_DEPS)" != "1"
!IF EXISTS("Makefile.Notify_Supplier.dep")
	@echo Using "Makefile.Notify_Supplier.dep"
!ELSE
	@echo Warning: cannot find "Makefile.Notify_Supplier.dep"
!ENDIF
!ENDIF
