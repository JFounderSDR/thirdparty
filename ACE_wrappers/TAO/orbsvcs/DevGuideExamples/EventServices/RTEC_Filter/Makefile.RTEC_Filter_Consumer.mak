...
!MESSAGE
!MESSAGE NMAKE /f "Makefile.RTEC_Filter_Consumer.mak" CFG="Win64 Debug"
!MESSAGE
...
OUTDIR=.
INSTALLDIR=.
INTDIR=Debug\RTEC_Filter_Consumer\IA64
...
!ELSE
	$(DEPGEN) -I"..\..\..\..\.." -I"..\..\..\.." -I"..\..\..\..\orbsvcs" -I"..\common" -D_DEBUG -DWIN64 -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -f "Makefile.RTEC_Filter_Consumer.dep" "EchoEventConsumerMain.cpp" "EchoEventConsumer_i.cpp"
!ENDIF
...
"$(INTDIR)" :
	...
	if not exist "Debug\RTEC_Filter_Consumer\$(NULL)" mkdir "Debug\RTEC_Filter_Consumer"
...
OUTDIR=Release
INSTALLDIR=Release
INTDIR=Release\RTEC_Filter_Consumer\IA64
...
!IF "$(DEPGEN)" == ""
	...
	@echo http://www.ociweb.com/products/mpc/down.html
!ELSE
	$(DEPGEN) -I"..\..\..\..\.." -I"..\..\..\.." -I"..\..\..\..\orbsvcs" -I"..\common" -DNDEBUG -DWIN64 -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -f "Makefile.RTEC_Filter_Consumer.dep" "EchoEventConsumerMain.cpp" "EchoEventConsumer_i.cpp"
!ENDIF
...
"$(INTDIR)" :
	...
	if not exist "Release\RTEC_Filter_Consumer\$(NULL)" mkdir "Release\RTEC_Filter_Consumer"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
INTDIR=Static_Debug\RTEC_Filter_Consumer\IA64
...
!IF "$(DEPGEN)" == ""
	...
	@echo http://www.ociweb.com/products/mpc/down.html
!ELSE
	$(DEPGEN) -I"..\..\..\..\.." -I"..\..\..\.." -I"..\..\..\..\orbsvcs" -I"..\common" -D_DEBUG -DWIN64 -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -DACE_AS_STATIC_LIBS -DTAO_AS_STATIC_LIBS -f "Makefile.RTEC_Filter_Consumer.dep" "EchoEventConsumerMain.cpp" "EchoEventConsumer_i.cpp"
!ENDIF
...
"$(INTDIR)" :
	...
	if not exist "Static_Debug\RTEC_Filter_Consumer\$(NULL)" mkdir "Static_Debug\RTEC_Filter_Consumer"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
INTDIR=Static_Release\RTEC_Filter_Consumer\IA64
...
!IF "$(DEPGEN)" == ""
	...
	@echo http://www.ociweb.com/products/mpc/down.html
!ELSE
	$(DEPGEN) -I"..\..\..\..\.." -I"..\..\..\.." -I"..\..\..\..\orbsvcs" -I"..\common" -DNDEBUG -DWIN64 -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -DACE_AS_STATIC_LIBS -DTAO_AS_STATIC_LIBS -f "Makefile.RTEC_Filter_Consumer.dep" "EchoEventConsumerMain.cpp" "EchoEventConsumer_i.cpp"
!ENDIF
...
"$(INTDIR)" :
	...
	if not exist "Static_Release\RTEC_Filter_Consumer\$(NULL)" mkdir "Static_Release\RTEC_Filter_Consumer"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
!IF EXISTS("Makefile.RTEC_Filter_Consumer.dep")
!INCLUDE "Makefile.RTEC_Filter_Consumer.dep"
!ENDIF
!ENDIF
...
!IF "$(NO_EXTERNAL_DEPS)" != "1"
!IF EXISTS("Makefile.RTEC_Filter_Consumer.dep")
	@echo Using "Makefile.RTEC_Filter_Consumer.dep"
!ELSE
	@echo Warning: cannot find "Makefile.RTEC_Filter_Consumer.dep"
!ENDIF
!ENDIF
