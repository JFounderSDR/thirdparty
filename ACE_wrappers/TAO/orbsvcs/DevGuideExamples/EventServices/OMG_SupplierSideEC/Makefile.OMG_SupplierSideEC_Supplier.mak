...
!MESSAGE
!MESSAGE NMAKE /f "Makefile.OMG_SupplierSideEC_Supplier.mak" CFG="Win64 Debug"
!MESSAGE
...
OUTDIR=.
INSTALLDIR=.
INTDIR=Debug\OMG_SupplierSideEC_Supplier\IA64
...
!ELSE
	$(DEPGEN) -I"..\..\..\..\.." -I"..\..\..\.." -I"..\..\..\..\orbsvcs" -I"..\common" -D_DEBUG -DWIN64 -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -DTAO_HAS_TYPED_EVENT_CHANNEL -f "Makefile.OMG_SupplierSideEC_Supplier.dep" "EchoEventSupplierMain.cpp"
!ENDIF
...
"$(INTDIR)" :
	...
	if not exist "Debug\OMG_SupplierSideEC_Supplier\$(NULL)" mkdir "Debug\OMG_SupplierSideEC_Supplier"
...
OUTDIR=Release
INSTALLDIR=Release
INTDIR=Release\OMG_SupplierSideEC_Supplier\IA64
...
!IF "$(DEPGEN)" == ""
	...
	@echo http://www.ociweb.com/products/mpc/down.html
!ELSE
	$(DEPGEN) -I"..\..\..\..\.." -I"..\..\..\.." -I"..\..\..\..\orbsvcs" -I"..\common" -DNDEBUG -DWIN64 -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -DTAO_HAS_TYPED_EVENT_CHANNEL -f "Makefile.OMG_SupplierSideEC_Supplier.dep" "EchoEventSupplierMain.cpp"
!ENDIF
...
"$(INTDIR)" :
	...
	if not exist "Release\OMG_SupplierSideEC_Supplier\$(NULL)" mkdir "Release\OMG_SupplierSideEC_Supplier"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
INTDIR=Static_Debug\OMG_SupplierSideEC_Supplier\IA64
...
!IF "$(DEPGEN)" == ""
	...
	@echo http://www.ociweb.com/products/mpc/down.html
!ELSE
	$(DEPGEN) -I"..\..\..\..\.." -I"..\..\..\.." -I"..\..\..\..\orbsvcs" -I"..\common" -D_DEBUG -DWIN64 -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -DTAO_HAS_TYPED_EVENT_CHANNEL -DACE_AS_STATIC_LIBS -DTAO_AS_STATIC_LIBS -f "Makefile.OMG_SupplierSideEC_Supplier.dep" "EchoEventSupplierMain.cpp"
!ENDIF
...
"$(INTDIR)" :
	...
	if not exist "Static_Debug\OMG_SupplierSideEC_Supplier\$(NULL)" mkdir "Static_Debug\OMG_SupplierSideEC_Supplier"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
INTDIR=Static_Release\OMG_SupplierSideEC_Supplier\IA64
...
!IF "$(DEPGEN)" == ""
	...
	@echo http://www.ociweb.com/products/mpc/down.html
!ELSE
	$(DEPGEN) -I"..\..\..\..\.." -I"..\..\..\.." -I"..\..\..\..\orbsvcs" -I"..\common" -DNDEBUG -DWIN64 -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -DTAO_HAS_TYPED_EVENT_CHANNEL -DACE_AS_STATIC_LIBS -DTAO_AS_STATIC_LIBS -f "Makefile.OMG_SupplierSideEC_Supplier.dep" "EchoEventSupplierMain.cpp"
!ENDIF
...
"$(INTDIR)" :
	...
	if not exist "Static_Release\OMG_SupplierSideEC_Supplier\$(NULL)" mkdir "Static_Release\OMG_SupplierSideEC_Supplier"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
LINK32=link.exe
LINK32_FLAGS=advapi32.lib user32.lib /INCREMENTAL:NO ACEs.lib TAOs.lib TAO_AnyTypeCodes.lib TAO_CosNamings.lib TAO_CosEvents.lib TAO_PortableServers.lib TAO_CosEvent_Skels.lib TAO_Valuetypes.lib TAO_CodecFactorys.lib TAO_PIs.lib TAO_Messagings.lib TAO_DynamicInterfaces.lib TAO_IFR_Clients.lib TAO_Svc_Utilss.lib TAO_CosEvent_Servs.lib /libpath:"." /libpath:"..\..\..\..\..\lib" /nologo /subsystem:console  /machine:IA64 /out:"$(INSTALLDIR)\EchoEventSupplier.exe"
LINK32_OBJS= \
	"$(INTDIR)\EchoEventSupplierMain.obj"
...
!IF EXISTS("Makefile.OMG_SupplierSideEC_Supplier.dep")
!INCLUDE "Makefile.OMG_SupplierSideEC_Supplier.dep"
!ENDIF
!ENDIF
...
!IF "$(NO_EXTERNAL_DEPS)" != "1"
!IF EXISTS("Makefile.OMG_SupplierSideEC_Supplier.dep")
	@echo Using "Makefile.OMG_SupplierSideEC_Supplier.dep"
!ELSE
	@echo Warning: cannot find "Makefile.OMG_SupplierSideEC_Supplier.dep"
!ENDIF
!ENDIF
