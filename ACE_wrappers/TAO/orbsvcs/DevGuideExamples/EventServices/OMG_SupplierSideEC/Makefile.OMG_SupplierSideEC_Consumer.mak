...
!MESSAGE
!MESSAGE NMAKE /f "Makefile.OMG_SupplierSideEC_Consumer.mak" CFG="Win64 Debug"
!MESSAGE
...
OUTDIR=.
INSTALLDIR=.
INTDIR=Debug\OMG_SupplierSideEC_Consumer\IA64
...
!ELSE
	$(DEPGEN) -I"..\..\..\..\.." -I"..\..\..\.." -I"..\..\..\..\orbsvcs" -I"..\common" -D_DEBUG -DWIN64 -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -DTAO_HAS_TYPED_EVENT_CHANNEL -f "Makefile.OMG_SupplierSideEC_Consumer.dep" "EchoEventConsumerMain.cpp" "EchoEventConsumer_i.cpp"
!ENDIF
...
"$(INTDIR)" :
	...
	if not exist "Debug\OMG_SupplierSideEC_Consumer\$(NULL)" mkdir "Debug\OMG_SupplierSideEC_Consumer"
...
OUTDIR=Release
INSTALLDIR=Release
INTDIR=Release\OMG_SupplierSideEC_Consumer\IA64
...
!IF "$(DEPGEN)" == ""
	...
	@echo http://www.ociweb.com/products/mpc/down.html
!ELSE
	$(DEPGEN) -I"..\..\..\..\.." -I"..\..\..\.." -I"..\..\..\..\orbsvcs" -I"..\common" -DNDEBUG -DWIN64 -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -DTAO_HAS_TYPED_EVENT_CHANNEL -f "Makefile.OMG_SupplierSideEC_Consumer.dep" "EchoEventConsumerMain.cpp" "EchoEventConsumer_i.cpp"
!ENDIF
...
"$(INTDIR)" :
	...
	if not exist "Release\OMG_SupplierSideEC_Consumer\$(NULL)" mkdir "Release\OMG_SupplierSideEC_Consumer"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
INTDIR=Static_Debug\OMG_SupplierSideEC_Consumer\IA64
...
"$(INTDIR)" :
	...
	if not exist "Static_Debug\OMG_SupplierSideEC_Consumer\$(NULL)" mkdir "Static_Debug\OMG_SupplierSideEC_Consumer"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
INTDIR=Static_Release\OMG_SupplierSideEC_Consumer\IA64
...
"$(INTDIR)" :
	...
	if not exist "Static_Release\OMG_SupplierSideEC_Consumer\$(NULL)" mkdir "Static_Release\OMG_SupplierSideEC_Consumer"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
!IF EXISTS("Makefile.OMG_SupplierSideEC_Consumer.dep")
!INCLUDE "Makefile.OMG_SupplierSideEC_Consumer.dep"
!ENDIF
!ENDIF
...
!IF "$(NO_EXTERNAL_DEPS)" != "1"
!IF EXISTS("Makefile.OMG_SupplierSideEC_Consumer.dep")
	@echo Using "Makefile.OMG_SupplierSideEC_Consumer.dep"
!ELSE
	@echo Warning: cannot find "Makefile.OMG_SupplierSideEC_Consumer.dep"
!ENDIF
!ENDIF
