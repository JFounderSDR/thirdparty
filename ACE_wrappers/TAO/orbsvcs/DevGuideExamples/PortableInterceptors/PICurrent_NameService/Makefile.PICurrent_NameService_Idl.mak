...
!MESSAGE
!MESSAGE NMAKE /f "Makefile.PICurrent_NameService_Idl.mak" CFG="Win64 Debug"
!MESSAGE
...
OUTDIR=.
INTDIR=Debug\PICurrent_NameService_Idl\IA64
...
"$(INTDIR)" :
	...
	if not exist "Debug\PICurrent_NameService_Idl\$(NULL)" mkdir "Debug\PICurrent_NameService_Idl"
...
OUTDIR=.
INTDIR=Release\PICurrent_NameService_Idl\IA64
...
"$(INTDIR)" :
	...
	if not exist "Release\PICurrent_NameService_Idl\$(NULL)" mkdir "Release\PICurrent_NameService_Idl"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
OUTDIR=.
INTDIR=Static_Debug\PICurrent_NameService_Idl\IA64
...
"$(INTDIR)" :
	...
	if not exist "Static_Debug\PICurrent_NameService_Idl\$(NULL)" mkdir "Static_Debug\PICurrent_NameService_Idl"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
OUTDIR=.
INTDIR=Static_Release\PICurrent_NameService_Idl\IA64
...
"$(INTDIR)" :
	...
	if not exist "Static_Release\PICurrent_NameService_Idl\$(NULL)" mkdir "Static_Release\PICurrent_NameService_Idl"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
!IF EXISTS("Makefile.PICurrent_NameService_Idl.dep")
!INCLUDE "Makefile.PICurrent_NameService_Idl.dep"
!ENDIF
!ENDIF
...
!IF "$(NO_EXTERNAL_DEPS)" != "1"
!IF EXISTS("Makefile.PICurrent_NameService_Idl.dep")
	@echo Using "Makefile.PICurrent_NameService_Idl.dep"
!ENDIF
!ENDIF
