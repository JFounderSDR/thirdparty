...
!MESSAGE
!MESSAGE NMAKE /f "Makefile.ImplRepo_Client.mak" CFG="Win64 Debug"
!MESSAGE
...
OUTDIR=.
INSTALLDIR=.
INTDIR=Debug\ImplRepo_Client\IA64
...
!ELSE
	$(DEPGEN) -I"..\..\..\.." -I"..\..\.." -D_DEBUG -DWIN64 -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -f "Makefile.ImplRepo_Client.dep" "MessengerClient.cpp" "MessengerC.cpp"
!ENDIF
...
"$(INTDIR)" :
	...
	if not exist "Debug\ImplRepo_Client\$(NULL)" mkdir "Debug\ImplRepo_Client"
...
OUTDIR=Release
INSTALLDIR=Release
INTDIR=Release\ImplRepo_Client\IA64
...
!IF "$(DEPGEN)" == ""
	...
	@echo http://www.ociweb.com/products/mpc/down.html
!ELSE
	$(DEPGEN) -I"..\..\..\.." -I"..\..\.." -DNDEBUG -DWIN64 -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -f "Makefile.ImplRepo_Client.dep" "MessengerClient.cpp" "MessengerC.cpp"
!ENDIF
...
"$(INTDIR)" :
	...
	if not exist "Release\ImplRepo_Client\$(NULL)" mkdir "Release\ImplRepo_Client"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
INTDIR=Static_Debug\ImplRepo_Client\IA64
...
!IF "$(DEPGEN)" == ""
	...
	@echo http://www.ociweb.com/products/mpc/down.html
!ELSE
	$(DEPGEN) -I"..\..\..\.." -I"..\..\.." -D_DEBUG -DWIN64 -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -DACE_AS_STATIC_LIBS -DTAO_AS_STATIC_LIBS -f "Makefile.ImplRepo_Client.dep" "MessengerClient.cpp" "MessengerC.cpp"
!ENDIF
...
"$(INTDIR)" :
	...
	if not exist "Static_Debug\ImplRepo_Client\$(NULL)" mkdir "Static_Debug\ImplRepo_Client"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
INTDIR=Static_Release\ImplRepo_Client\IA64
...
!IF "$(DEPGEN)" == ""
	...
	@echo http://www.ociweb.com/products/mpc/down.html
!ELSE
	$(DEPGEN) -I"..\..\..\.." -I"..\..\.." -DNDEBUG -DWIN64 -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -DACE_AS_STATIC_LIBS -DTAO_AS_STATIC_LIBS -f "Makefile.ImplRepo_Client.dep" "MessengerClient.cpp" "MessengerC.cpp"
!ENDIF
...
"$(INTDIR)" :
	...
	if not exist "Static_Release\ImplRepo_Client\$(NULL)" mkdir "Static_Release\ImplRepo_Client"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
!IF EXISTS("Makefile.ImplRepo_Client.dep")
!INCLUDE "Makefile.ImplRepo_Client.dep"
!ENDIF
!ENDIF
...
!IF "$(NO_EXTERNAL_DEPS)" != "1"
!IF EXISTS("Makefile.ImplRepo_Client.dep")
	@echo Using "Makefile.ImplRepo_Client.dep"
!ELSE
	@echo Warning: cannot find "Makefile.ImplRepo_Client.dep"
!ENDIF
!ENDIF
