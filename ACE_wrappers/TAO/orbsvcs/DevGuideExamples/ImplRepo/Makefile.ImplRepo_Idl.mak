...
!MESSAGE
!MESSAGE NMAKE /f "Makefile.ImplRepo_Idl.mak" CFG="Win64 Debug"
!MESSAGE
...
OUTDIR=.
INTDIR=Debug\ImplRepo_Idl\IA64
...
"$(INTDIR)" :
	...
	if not exist "Debug\ImplRepo_Idl\$(NULL)" mkdir "Debug\ImplRepo_Idl"
...
OUTDIR=.
INTDIR=Release\ImplRepo_Idl\IA64
...
"$(INTDIR)" :
	...
	if not exist "Release\ImplRepo_Idl\$(NULL)" mkdir "Release\ImplRepo_Idl"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
OUTDIR=.
INTDIR=Static_Debug\ImplRepo_Idl\IA64
...
"$(INTDIR)" :
	...
	if not exist "Static_Debug\ImplRepo_Idl\$(NULL)" mkdir "Static_Debug\ImplRepo_Idl"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
OUTDIR=.
INTDIR=Static_Release\ImplRepo_Idl\IA64
...
"$(INTDIR)" :
	...
	if not exist "Static_Release\ImplRepo_Idl\$(NULL)" mkdir "Static_Release\ImplRepo_Idl"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
!IF EXISTS("Makefile.ImplRepo_Idl.dep")
!INCLUDE "Makefile.ImplRepo_Idl.dep"
!ENDIF
!ENDIF
...
!IF "$(NO_EXTERNAL_DEPS)" != "1"
!IF EXISTS("Makefile.ImplRepo_Idl.dep")
	@echo Using "Makefile.ImplRepo_Idl.dep"
!ENDIF
!ENDIF
