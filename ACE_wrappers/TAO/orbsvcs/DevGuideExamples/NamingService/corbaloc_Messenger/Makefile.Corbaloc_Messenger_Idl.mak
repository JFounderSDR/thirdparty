...
!MESSAGE
!MESSAGE NMAKE /f "Makefile.Corbaloc_Messenger_Idl.mak" CFG="Win64 Debug"
!MESSAGE
...
OUTDIR=.
INTDIR=Debug\Corbaloc_Messenger_Idl\IA64
...
"$(INTDIR)" :
	...
	if not exist "Debug\Corbaloc_Messenger_Idl\$(NULL)" mkdir "Debug\Corbaloc_Messenger_Idl"
...
OUTDIR=.
INTDIR=Release\Corbaloc_Messenger_Idl\IA64
...
"$(INTDIR)" :
	...
	if not exist "Release\Corbaloc_Messenger_Idl\$(NULL)" mkdir "Release\Corbaloc_Messenger_Idl"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
OUTDIR=.
INTDIR=Static_Debug\Corbaloc_Messenger_Idl\IA64
...
"$(INTDIR)" :
	...
	if not exist "Static_Debug\Corbaloc_Messenger_Idl\$(NULL)" mkdir "Static_Debug\Corbaloc_Messenger_Idl"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
OUTDIR=.
INTDIR=Static_Release\Corbaloc_Messenger_Idl\IA64
...
"$(INTDIR)" :
	...
	if not exist "Static_Release\Corbaloc_Messenger_Idl\$(NULL)" mkdir "Static_Release\Corbaloc_Messenger_Idl"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
!IF EXISTS("Makefile.Corbaloc_Messenger_Idl.dep")
!INCLUDE "Makefile.Corbaloc_Messenger_Idl.dep"
!ENDIF
!ENDIF
...
!IF "$(NO_EXTERNAL_DEPS)" != "1"
!IF EXISTS("Makefile.Corbaloc_Messenger_Idl.dep")
	@echo Using "Makefile.Corbaloc_Messenger_Idl.dep"
!ENDIF
!ENDIF
