...
!MESSAGE
!MESSAGE NMAKE /f "Makefile.Naming_Context_Ext_Idl.mak" CFG="Win64 Debug"
!MESSAGE
...
OUTDIR=.
INTDIR=Debug\Naming_Context_Ext_Idl\IA64
...
"$(INTDIR)" :
	...
	if not exist "Debug\Naming_Context_Ext_Idl\$(NULL)" mkdir "Debug\Naming_Context_Ext_Idl"
...
OUTDIR=.
INTDIR=Release\Naming_Context_Ext_Idl\IA64
...
"$(INTDIR)" :
	...
	if not exist "Release\Naming_Context_Ext_Idl\$(NULL)" mkdir "Release\Naming_Context_Ext_Idl"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
OUTDIR=.
INTDIR=Static_Debug\Naming_Context_Ext_Idl\IA64
...
"$(INTDIR)" :
	...
	if not exist "Static_Debug\Naming_Context_Ext_Idl\$(NULL)" mkdir "Static_Debug\Naming_Context_Ext_Idl"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
OUTDIR=.
INTDIR=Static_Release\Naming_Context_Ext_Idl\IA64
...
"$(INTDIR)" :
	...
	if not exist "Static_Release\Naming_Context_Ext_Idl\$(NULL)" mkdir "Static_Release\Naming_Context_Ext_Idl"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
!IF EXISTS("Makefile.Naming_Context_Ext_Idl.dep")
!INCLUDE "Makefile.Naming_Context_Ext_Idl.dep"
!ENDIF
!ENDIF
...
!IF "$(NO_EXTERNAL_DEPS)" != "1"
!IF EXISTS("Makefile.Naming_Context_Ext_Idl.dep")
	@echo Using "Makefile.Naming_Context_Ext_Idl.dep"
!ENDIF
!ENDIF
