...
!MESSAGE
!MESSAGE NMAKE /f "Makefile.NamingService_Messenger_Idl.mak" CFG="Win64 Debug"
!MESSAGE
...
OUTDIR=.
INTDIR=Debug\NamingService_Messenger_Idl\IA64
...
"$(INTDIR)" :
	...
	if not exist "Debug\NamingService_Messenger_Idl\$(NULL)" mkdir "Debug\NamingService_Messenger_Idl"
...
OUTDIR=.
INTDIR=Release\NamingService_Messenger_Idl\IA64
...
"$(INTDIR)" :
	...
	if not exist "Release\NamingService_Messenger_Idl\$(NULL)" mkdir "Release\NamingService_Messenger_Idl"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
OUTDIR=.
INTDIR=Static_Debug\NamingService_Messenger_Idl\IA64
...
"$(INTDIR)" :
	...
	if not exist "Static_Debug\NamingService_Messenger_Idl\$(NULL)" mkdir "Static_Debug\NamingService_Messenger_Idl"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
OUTDIR=.
INTDIR=Static_Release\NamingService_Messenger_Idl\IA64
...
"$(INTDIR)" :
	...
	if not exist "Static_Release\NamingService_Messenger_Idl\$(NULL)" mkdir "Static_Release\NamingService_Messenger_Idl"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
!IF EXISTS("Makefile.NamingService_Messenger_Idl.dep")
!INCLUDE "Makefile.NamingService_Messenger_Idl.dep"
!ENDIF
!ENDIF
...
!IF "$(NO_EXTERNAL_DEPS)" != "1"
!IF EXISTS("Makefile.NamingService_Messenger_Idl.dep")
	@echo Using "Makefile.NamingService_Messenger_Idl.dep"
!ENDIF
!ENDIF
