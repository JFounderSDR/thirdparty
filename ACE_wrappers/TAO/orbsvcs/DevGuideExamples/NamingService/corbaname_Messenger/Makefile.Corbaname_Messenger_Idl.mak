...
!MESSAGE
!MESSAGE NMAKE /f "Makefile.Corbaname_Messenger_Idl.mak" CFG="Win64 Debug"
!MESSAGE
...
OUTDIR=.
INTDIR=Debug\Corbaname_Messenger_Idl\IA64
...
"$(INTDIR)" :
	...
	if not exist "Debug\Corbaname_Messenger_Idl\$(NULL)" mkdir "Debug\Corbaname_Messenger_Idl"
...
OUTDIR=.
INTDIR=Release\Corbaname_Messenger_Idl\IA64
...
"$(INTDIR)" :
	...
	if not exist "Release\Corbaname_Messenger_Idl\$(NULL)" mkdir "Release\Corbaname_Messenger_Idl"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
OUTDIR=.
INTDIR=Static_Debug\Corbaname_Messenger_Idl\IA64
...
"$(INTDIR)" :
	...
	if not exist "Static_Debug\Corbaname_Messenger_Idl\$(NULL)" mkdir "Static_Debug\Corbaname_Messenger_Idl"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
OUTDIR=.
INTDIR=Static_Release\Corbaname_Messenger_Idl\IA64
...
"$(INTDIR)" :
	...
	if not exist "Static_Release\Corbaname_Messenger_Idl\$(NULL)" mkdir "Static_Release\Corbaname_Messenger_Idl"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
!IF EXISTS("Makefile.Corbaname_Messenger_Idl.dep")
!INCLUDE "Makefile.Corbaname_Messenger_Idl.dep"
!ENDIF
!ENDIF
...
!IF "$(NO_EXTERNAL_DEPS)" != "1"
!IF EXISTS("Makefile.Corbaname_Messenger_Idl.dep")
	@echo Using "Makefile.Corbaname_Messenger_Idl.dep"
!ENDIF
!ENDIF
