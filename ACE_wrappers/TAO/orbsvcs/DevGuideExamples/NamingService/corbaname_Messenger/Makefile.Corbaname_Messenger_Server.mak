...
!MESSAGE
!MESSAGE NMAKE /f "Makefile.Corbaname_Messenger_Server.mak" CFG="Win64 Debug"
!MESSAGE
...
OUTDIR=.
INSTALLDIR=.
INTDIR=Debug\Corbaname_Messenger_Server\IA64
...
!ELSE
	$(DEPGEN) -I"..\..\..\..\.." -I"..\..\..\.." -I"..\..\..\..\orbsvcs" -D_DEBUG -DWIN64 -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -f "Makefile.Corbaname_Messenger_Server.dep" "Messenger_i.cpp" "MessengerServer.cpp" "MessengerC.cpp" "MessengerS.cpp"
!ENDIF
...
"$(INTDIR)" :
	...
	if not exist "Debug\Corbaname_Messenger_Server\$(NULL)" mkdir "Debug\Corbaname_Messenger_Server"
...
OUTDIR=Release
INSTALLDIR=Release
INTDIR=Release\Corbaname_Messenger_Server\IA64
...
!IF "$(DEPGEN)" == ""
	...
	@echo http://www.ociweb.com/products/mpc/down.html
!ELSE
	$(DEPGEN) -I"..\..\..\..\.." -I"..\..\..\.." -I"..\..\..\..\orbsvcs" -DNDEBUG -DWIN64 -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -f "Makefile.Corbaname_Messenger_Server.dep" "Messenger_i.cpp" "MessengerServer.cpp" "MessengerC.cpp" "MessengerS.cpp"
!ENDIF
...
"$(INTDIR)" :
	...
	if not exist "Release\Corbaname_Messenger_Server\$(NULL)" mkdir "Release\Corbaname_Messenger_Server"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
INTDIR=Static_Debug\Corbaname_Messenger_Server\IA64
...
!IF "$(DEPGEN)" == ""
	...
	@echo http://www.ociweb.com/products/mpc/down.html
!ELSE
	$(DEPGEN) -I"..\..\..\..\.." -I"..\..\..\.." -I"..\..\..\..\orbsvcs" -D_DEBUG -DWIN64 -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -DACE_AS_STATIC_LIBS -DTAO_AS_STATIC_LIBS -f "Makefile.Corbaname_Messenger_Server.dep" "Messenger_i.cpp" "MessengerServer.cpp" "MessengerC.cpp" "MessengerS.cpp"
!ENDIF
...
"$(INTDIR)" :
	...
	if not exist "Static_Debug\Corbaname_Messenger_Server\$(NULL)" mkdir "Static_Debug\Corbaname_Messenger_Server"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
INTDIR=Static_Release\Corbaname_Messenger_Server\IA64
...
!IF "$(DEPGEN)" == ""
	...
	@echo http://www.ociweb.com/products/mpc/down.html
!ELSE
	$(DEPGEN) -I"..\..\..\..\.." -I"..\..\..\.." -I"..\..\..\..\orbsvcs" -DNDEBUG -DWIN64 -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -DACE_AS_STATIC_LIBS -DTAO_AS_STATIC_LIBS -f "Makefile.Corbaname_Messenger_Server.dep" "Messenger_i.cpp" "MessengerServer.cpp" "MessengerC.cpp" "MessengerS.cpp"
!ENDIF
...
"$(INTDIR)" :
	...
	if not exist "Static_Release\Corbaname_Messenger_Server\$(NULL)" mkdir "Static_Release\Corbaname_Messenger_Server"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
!IF EXISTS("Makefile.Corbaname_Messenger_Server.dep")
!INCLUDE "Makefile.Corbaname_Messenger_Server.dep"
!ENDIF
!ENDIF
...
!IF "$(NO_EXTERNAL_DEPS)" != "1"
!IF EXISTS("Makefile.Corbaname_Messenger_Server.dep")
	@echo Using "Makefile.Corbaname_Messenger_Server.dep"
!ELSE
	@echo Warning: cannot find "Makefile.Corbaname_Messenger_Server.dep"
!ENDIF
!ENDIF
