...
all: CosEvent_Service

clean depend generated realclean $(CUSTOM_TARGETS):
	@echo Project: Makefile.CosEvent_Service.mak
	$(MAKE) /$(MAKEFLAGS) /f Makefile.CosEvent_Service.mak CFG="$(CFG)" $(@)

CosEvent_Service:
	@echo Project: Makefile.CosEvent_Service.mak
	$(MAKE) /$(MAKEFLAGS) /f Makefile.CosEvent_Service.mak CFG="$(CFG)" all
