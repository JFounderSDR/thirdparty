...
all: Scheduling_Service

clean depend generated realclean $(CUSTOM_TARGETS):
	@echo Project: Makefile.Scheduling_Service.mak
	$(MAKE) /$(MAKEFLAGS) /f Makefile.Scheduling_Service.mak CFG="$(CFG)" $(@)

Scheduling_Service:
	@echo Project: Makefile.Scheduling_Service.mak
	$(MAKE) /$(MAKEFLAGS) /f Makefile.Scheduling_Service.mak CFG="$(CFG)" all
