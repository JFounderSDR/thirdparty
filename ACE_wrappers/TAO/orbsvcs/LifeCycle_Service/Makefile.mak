...
all: LifeCycle_Service

clean depend generated realclean $(CUSTOM_TARGETS):
	@echo Project: Makefile.LifeCycle_Service.mak
	$(MAKE) /$(MAKEFLAGS) /f Makefile.LifeCycle_Service.mak CFG="$(CFG)" $(@)

LifeCycle_Service:
	@echo Project: Makefile.LifeCycle_Service.mak
	$(MAKE) /$(MAKEFLAGS) /f Makefile.LifeCycle_Service.mak CFG="$(CFG)" all
