...
!MESSAGE
!MESSAGE NMAKE /f "Makefile.DynamicAny_Idl.mak" CFG="Win64 Debug"
!MESSAGE
...
GENERATED_DIRTY = "DynamicAnyC.h" "DynamicAnyS.h" "DynamicAnyC.cpp"

!IF  "$(CFG)" == "Win64 Debug"

OUTDIR=.
INTDIR=Debug\DynamicAny_Idl\IA64
...
REALCLEAN : CLEAN
	...
	-@del /f/q "DynamicAnyC.h"
	-@del /f/q "DynamicAnyS.h"
	-@del /f/q "DynamicAnyC.cpp"

"$(INTDIR)" :
	if not exist "Debug\$(NULL)" mkdir "Debug"
	if not exist "Debug\DynamicAny_Idl\$(NULL)" mkdir "Debug\DynamicAny_Idl"
...
OUTDIR=.
INTDIR=Release\DynamicAny_Idl\IA64
...
"$(INTDIR)" :
	...
	if not exist "Release\DynamicAny_Idl\$(NULL)" mkdir "Release\DynamicAny_Idl"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
OUTDIR=.
INTDIR=Static_Debug\DynamicAny_Idl\IA64
...
"$(INTDIR)" :
	...
	if not exist "Static_Debug\DynamicAny_Idl\$(NULL)" mkdir "Static_Debug\DynamicAny_Idl"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
OUTDIR=.
INTDIR=Static_Release\DynamicAny_Idl\IA64
...
"$(INTDIR)" :
	...
	if not exist "Static_Release\DynamicAny_Idl\$(NULL)" mkdir "Static_Release\DynamicAny_Idl"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
"DynamicAnyC.h" "DynamicAnyS.h" "DynamicAnyC.cpp" : $(SOURCE)  "..\..\..\bin\tao_idl.exe" "..\..\..\lib\TAO_IDL_BE.dll" "..\..\..\lib\TAO_IDL_FE.dll"
	<<tempfile-Win64-Release-idl_files-DynamicAny_pidl.bat
	@echo off
	PATH=%PATH%;..\..\..\lib
	..\..\..\bin\tao_idl -Wb,pre_include=ace/pre.h -Wb,post_include=ace/post.h -I..\.. -Wb,versioning_begin=TAO_BEGIN_VERSIONED_NAMESPACE_DECL -Wb,versioning_end=TAO_END_VERSIONED_NAMESPACE_DECL -Gp -Gd -Sci -SS -Sorb -Wb,export_macro=TAO_DynamicAny_Export -Wb,export_include=tao/DynamicAny/dynamicany_export.h -Wb,include_guard=TAO_DYNAMICANY_SAFE_INCLUDE -Wb,safe_include=tao/DynamicAny/DynamicAny.h -iC tao/DynamicAny "$(InputPath)"
<<
...
"DynamicAnyC.h" "DynamicAnyS.h" "DynamicAnyC.cpp" : $(SOURCE)  "..\..\..\bin\tao_idl.exe"
	<<tempfile-Win64-Static_Debug-idl_files-DynamicAny_pidl.bat
	@echo off
	PATH=%PATH%;..\..\..\lib
	..\..\..\bin\tao_idl -Wb,pre_include=ace/pre.h -Wb,post_include=ace/post.h -I..\.. -Wb,versioning_begin=TAO_BEGIN_VERSIONED_NAMESPACE_DECL -Wb,versioning_end=TAO_END_VERSIONED_NAMESPACE_DECL -Gp -Gd -Sci -SS -Sorb -Wb,export_macro=TAO_DynamicAny_Export -Wb,export_include=tao/DynamicAny/dynamicany_export.h -Wb,include_guard=TAO_DYNAMICANY_SAFE_INCLUDE -Wb,safe_include=tao/DynamicAny/DynamicAny.h -iC tao/DynamicAny "$(InputPath)"
<<
...
"DynamicAnyC.h" "DynamicAnyS.h" "DynamicAnyC.cpp" : $(SOURCE)  "..\..\..\bin\tao_idl.exe"
	<<tempfile-Win64-Static_Release-idl_files-DynamicAny_pidl.bat
	@echo off
	PATH=%PATH%;..\..\..\lib
	..\..\..\bin\tao_idl -Wb,pre_include=ace/pre.h -Wb,post_include=ace/post.h -I..\.. -Wb,versioning_begin=TAO_BEGIN_VERSIONED_NAMESPACE_DECL -Wb,versioning_end=TAO_END_VERSIONED_NAMESPACE_DECL -Gp -Gd -Sci -SS -Sorb -Wb,export_macro=TAO_DynamicAny_Export -Wb,export_include=tao/DynamicAny/dynamicany_export.h -Wb,include_guard=TAO_DYNAMICANY_SAFE_INCLUDE -Wb,safe_include=tao/DynamicAny/DynamicAny.h -iC tao/DynamicAny "$(InputPath)"
<<
...
!IF "$(NO_EXTERNAL_DEPS)" != "1"
!IF EXISTS("Makefile.DynamicAny_Idl.dep")
	@echo Using "Makefile.DynamicAny_Idl.dep"
!ENDIF
!ENDIF
