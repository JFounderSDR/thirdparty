...
namespace IIOP
{
    ...
    )
  {
    if (0 == &_tao_elem) // Trying to de-reference NULL object
      _tao_any <<= static_cast< ::IIOP::ListenPoint *>( 0 ); // Use non-copying insertion of a NULL
    else
...
namespace IIOP
{
  ...
  {
    if (0 == &_tao_elem) // Trying to de-reference NULL object
      _tao_any <<= static_cast< ::IIOP::ListenPointList *>( 0 ); // Use non-copying insertion of a NULL
    else
...
namespace IIOP
{
  ...
  {
    if (0 == &_tao_elem) // Trying to de-reference NULL object
      _tao_any <<= static_cast< ::IIOP::BiDirIIOPServiceContext *>( 0 ); // Use non-copying insertion of a NULL
    else
