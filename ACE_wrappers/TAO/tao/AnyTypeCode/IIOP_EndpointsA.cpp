...
namespace TAO
{
    ...
    )
  {
    if (0 == &_tao_elem) // Trying to de-reference NULL object
      _tao_any <<= static_cast< ::TAO::IIOP_Endpoint_Info *>( 0 ); // Use non-copying insertion of a NULL
    else
...
namespace TAO
{
  ...
  {
    if (0 == &_tao_elem) // Trying to de-reference NULL object
      _tao_any <<= static_cast< ::TAO::IIOPEndpointSequence *>( 0 ); // Use non-copying insertion of a NULL
    else
