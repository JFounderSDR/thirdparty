...
namespace CORBA
{
    ...
    )
  {
    if (0 == &_tao_elem) // Trying to de-reference NULL object
      _tao_any <<= static_cast< ::CORBA::ServiceOptionSeq *>( 0 ); // Use non-copying insertion of a NULL
    else
...
namespace CORBA
{
  ...
  {
    if (0 == &_tao_elem) // Trying to de-reference NULL object
      _tao_any <<= static_cast< ::CORBA::ServiceDetail *>( 0 ); // Use non-copying insertion of a NULL
    else
...
namespace CORBA
{
  ...
  {
    if (0 == &_tao_elem) // Trying to de-reference NULL object
      _tao_any <<= static_cast< ::CORBA::ServiceDetailSeq *>( 0 ); // Use non-copying insertion of a NULL
    else
...
namespace CORBA
{
  ...
  {
    if (0 == &_tao_elem) // Trying to de-reference NULL object
      _tao_any <<= static_cast< ::CORBA::ServiceInformation *>( 0 ); // Use non-copying insertion of a NULL
    else
