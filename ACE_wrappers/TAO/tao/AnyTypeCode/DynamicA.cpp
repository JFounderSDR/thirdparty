...
namespace Dynamic
{
    ...
    )
  {
    if (0 == &_tao_elem) // Trying to de-reference NULL object
      _tao_any <<= static_cast< ::Dynamic::ParameterList *>( 0 ); // Use non-copying insertion of a NULL
    else
...
namespace Dynamic
{
  ...
  {
    if (0 == &_tao_elem) // Trying to de-reference NULL object
      _tao_any <<= static_cast< ::Dynamic::ExceptionList *>( 0 ); // Use non-copying insertion of a NULL
    else
