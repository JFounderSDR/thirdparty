...
namespace IOP
{
    ...
    )
  {
    if (0 == &_tao_elem) // Trying to de-reference NULL object
      _tao_any <<= static_cast< ::IOP::TaggedProfile *>( 0 ); // Use non-copying insertion of a NULL
    else
...
namespace IOP
{
  ...
  {
    if (0 == &_tao_elem) // Trying to de-reference NULL object
      _tao_any <<= static_cast< ::IOP::TaggedProfileSeq *>( 0 ); // Use non-copying insertion of a NULL
    else
...
namespace IOP
{
  ...
  {
    if (0 == &_tao_elem) // Trying to de-reference NULL object
      _tao_any <<= static_cast< ::IOP::IOR *>( 0 ); // Use non-copying insertion of a NULL
    else
...
namespace IOP
{
  ...
  {
    if (0 == &_tao_elem) // Trying to de-reference NULL object
      _tao_any <<= static_cast< ::IOP::TaggedComponent *>( 0 ); // Use non-copying insertion of a NULL
    else
...
namespace IOP
{
  ...
  {
    if (0 == &_tao_elem) // Trying to de-reference NULL object
      _tao_any <<= static_cast< ::IOP::MultipleComponentProfile *>( 0 ); // Use non-copying insertion of a NULL
    else
...
namespace IOP
{
  ...
  {
    if (0 == &_tao_elem) // Trying to de-reference NULL object
      _tao_any <<= static_cast< ::IOP::TaggedComponentSeq *>( 0 ); // Use non-copying insertion of a NULL
    else
...
namespace IOP
{
  ...
  {
    if (0 == &_tao_elem) // Trying to de-reference NULL object
      _tao_any <<= static_cast< ::IOP::ServiceContext *>( 0 ); // Use non-copying insertion of a NULL
    else
...
namespace IOP
{
  ...
  {
    if (0 == &_tao_elem) // Trying to de-reference NULL object
      _tao_any <<= static_cast< ::IOP::ServiceContextList *>( 0 ); // Use non-copying insertion of a NULL
    else
