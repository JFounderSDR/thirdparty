...
namespace ImplementationRepository
{
    ...
    )
  {
    if (0 == &_tao_elem) // Trying to de-reference NULL object
      _tao_any <<= static_cast< ::ImplementationRepository::EnvironmentVariable *>( 0 ); // Use non-copying insertion of a NULL
    else
...
namespace ImplementationRepository
{
  ...
  {
    if (0 == &_tao_elem) // Trying to de-reference NULL object
      _tao_any <<= static_cast< ::ImplementationRepository::EnvironmentList *>( 0 ); // Use non-copying insertion of a NULL
    else
...
namespace ImplementationRepository
{
  ...
  {
    if (0 == &_tao_elem) // Trying to de-reference NULL object
      _tao_any <<= static_cast< ::ImplementationRepository::StartupOptions *>( 0 ); // Use non-copying insertion of a NULL
    else
...
namespace ImplementationRepository
{
  ...
  {
    if (0 == &_tao_elem) // Trying to de-reference NULL object
      _tao_any <<= static_cast< ::ImplementationRepository::ServerInformation *>( 0 ); // Use non-copying insertion of a NULL
    else
...
namespace ImplementationRepository
{
  ...
  {
    if (0 == &_tao_elem) // Trying to de-reference NULL object
      _tao_any <<= static_cast< ::ImplementationRepository::ServerInformationList *>( 0 ); // Use non-copying insertion of a NULL
    else
