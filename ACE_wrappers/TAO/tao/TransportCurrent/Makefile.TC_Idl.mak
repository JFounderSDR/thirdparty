...
!MESSAGE
!MESSAGE NMAKE /f "Makefile.TC_Idl.mak" CFG="Win64 Debug"
!MESSAGE
...
GENERATED_DIRTY = "TCC.h" "TCS.h" "TCC.cpp"

!IF  "$(CFG)" == "Win64 Debug"

OUTDIR=.
INTDIR=Debug\TC_Idl\IA64
...
"$(INTDIR)" :
	...
	if not exist "Debug\TC_Idl\$(NULL)" mkdir "Debug\TC_Idl"
...
"$(INTDIR)" :
	...
	if not exist "Release\TC_Idl\$(NULL)" mkdir "Release\TC_Idl"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
OUTDIR=.
INTDIR=Static_Debug\TC_Idl\IA64
...
"$(INTDIR)" :
	...
	if not exist "Static_Debug\TC_Idl\$(NULL)" mkdir "Static_Debug\TC_Idl"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
OUTDIR=.
INTDIR=Static_Release\TC_Idl\IA64
...
"$(INTDIR)" :
	...
	if not exist "Static_Release\TC_Idl\$(NULL)" mkdir "Static_Release\TC_Idl"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
...
!IF EXISTS("Makefile.TC_Idl.dep")
!INCLUDE "Makefile.TC_Idl.dep"
!ENDIF
!ENDIF
...
"TCC.h" "TCS.h" "TCC.cpp" : $(SOURCE)  "..\..\..\bin\tao_idl.exe" "..\..\..\lib\TAO_IDL_BEd.dll" "..\..\..\lib\TAO_IDL_FEd.dll"
	<<tempfile-Win64-Debug-idl_files-TC_idl.bat
	@echo off
	PATH=%PATH%;..\..\..\lib
...
"TCC.h" "TCS.h" "TCC.cpp" : $(SOURCE)  "..\..\..\bin\tao_idl.exe" "..\..\..\lib\TAO_IDL_BE.dll" "..\..\..\lib\TAO_IDL_FE.dll"
	<<tempfile-Win64-Release-idl_files-TC_idl.bat
	@echo off
	PATH=%PATH%;..\..\..\lib
	..\..\..\bin\tao_idl -Wb,pre_include=ace/pre.h -Wb,post_include=ace/post.h -I..\.. -Wb,versioning_begin=TAO_BEGIN_VERSIONED_NAMESPACE_DECL -Wb,versioning_end=TAO_END_VERSIONED_NAMESPACE_DECL -Wb,export_include=tao/TransportCurrent/Transport_Current_Export.h -Wb,export_macro=TAO_Transport_Current_Export -iC tao/TransportCurrent -I./TransportCurrent -SS -Sci "$(InputPath)"
<<
...
"TCC.h" "TCS.h" "TCC.cpp" : $(SOURCE)  "..\..\..\bin\tao_idl.exe"
	<<tempfile-Win64-Static_Debug-idl_files-TC_idl.bat
	@echo off
	PATH=%PATH%;..\..\..\lib
	..\..\..\bin\tao_idl -Wb,pre_include=ace/pre.h -Wb,post_include=ace/post.h -I..\.. -Wb,versioning_begin=TAO_BEGIN_VERSIONED_NAMESPACE_DECL -Wb,versioning_end=TAO_END_VERSIONED_NAMESPACE_DECL -Wb,export_include=tao/TransportCurrent/Transport_Current_Export.h -Wb,export_macro=TAO_Transport_Current_Export -iC tao/TransportCurrent -I./TransportCurrent -SS -Sci "$(InputPath)"
<<
...
"TCC.h" "TCS.h" "TCC.cpp" : $(SOURCE)  "..\..\..\bin\tao_idl.exe"
	<<tempfile-Win64-Static_Release-idl_files-TC_idl.bat
	@echo off
	PATH=%PATH%;..\..\..\lib
	..\..\..\bin\tao_idl -Wb,pre_include=ace/pre.h -Wb,post_include=ace/post.h -I..\.. -Wb,versioning_begin=TAO_BEGIN_VERSIONED_NAMESPACE_DECL -Wb,versioning_end=TAO_END_VERSIONED_NAMESPACE_DECL -Wb,export_include=tao/TransportCurrent/Transport_Current_Export.h -Wb,export_macro=TAO_Transport_Current_Export -iC tao/TransportCurrent -I./TransportCurrent -SS -Sci "$(InputPath)"
<<
...
!IF "$(NO_EXTERNAL_DEPS)" != "1"
!IF EXISTS("Makefile.TC_Idl.dep")
	@echo Using "Makefile.TC_Idl.dep"
!ENDIF
!ENDIF
